/*
       ...
       Generated on: February 19, 2017 17:32:41.20
...
public final  class gx0106_impl extends GXDataArea
{
   public gx0106_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gx0106_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gx0106_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201721917324125");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   {
      return formatLink("com.kberp.gx0106") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7pEmpresaId,6,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV8pEntidadId,6,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV9pCfgComprobanteId)) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV10pCfgComprobantePrefijo,4,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV11pComprobanteNumero,8,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV12pCfgComprobanteDetalleLetra,2,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV13pArticuloId)) ;
   }
   ...
   public void wb110( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblarticuloidfilter_Internalname, "Articulo Id", "", "", lblLblarticuloidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11111_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0106.htm");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12111_client"+"'", TempTags, "", 2, "HLP_Gx0106.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 24 )
      {
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0106.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void rf112( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A35CfgComprobanteDetalleLetra = H00112_A35CfgComprobanteDetalleLetra[0] ;
            httpContext.ajax_rsp_assign_attri("", false, cmbCfgComprobanteDetalleLetra.getInternalname(), GXutil.ltrim( GXutil.str( A35CfgComprobanteDetalleLetra, 2, 0)));
            A55ComprobanteNumero = H00112_A55ComprobanteNumero[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtComprobanteNumero_Internalname, GXutil.ltrim( GXutil.str( A55ComprobanteNumero, 8, 0)));
            A32CfgComprobantePrefijo = H00112_A32CfgComprobantePrefijo[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtCfgComprobantePrefijo_Internalname, GXutil.ltrim( GXutil.str( A32CfgComprobantePrefijo, 4, 0)));
            A31CfgComprobanteId = H00112_A31CfgComprobanteId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtCfgComprobanteId_Internalname, A31CfgComprobanteId);
            A81EntidadId = H00112_A81EntidadId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadId_Internalname, GXutil.ltrim( GXutil.str( A81EntidadId, 6, 0)));
            A42EmpresaId = H00112_A42EmpresaId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEmpresaId_Internalname, GXutil.ltrim( GXutil.str( A42EmpresaId, 6, 0)));
            A66ComprobanteArticuloTotal = H00112_A66ComprobanteArticuloTotal[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtComprobanteArticuloTotal_Internalname, GXutil.ltrim( GXutil.str( A66ComprobanteArticuloTotal, 12, 2)));
            A65ComprobanteArticuloPrecioUnit = H00112_A65ComprobanteArticuloPrecioUnit[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtComprobanteArticuloPrecioUnit_Internalname, GXutil.ltrim( GXutil.str( A65ComprobanteArticuloPrecioUnit, 12, 2)));
            A64ComprobanteArticuloCantidad = H00112_A64ComprobanteArticuloCantidad[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtComprobanteArticuloCantidad_Internalname, GXutil.ltrim( GXutil.str( A64ComprobanteArticuloCantidad, 10, 3)));
            A39ArticuloId = H00112_A39ArticuloId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtArticuloId_Internalname, A39ArticuloId);
            /* Execute user event: Load */
            e14112 ();
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201721917324199");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0106.js", "?201721917324199");
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'TOGGLE'","{handler:'e12111',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLARTICULOIDFILTER.CLICK","{handler:'e11111',iparms:[{av:'divArticuloidfiltercontainer_Class',ctrl:'ARTICULOIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divArticuloidfiltercontainer_Class',ctrl:'ARTICULOIDFILTERCONTAINER',prop:'Class'},{av:'edtavCarticuloid_Visible',ctrl:'vCARTICULOID',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e15112',iparms:[{av:'A39ArticuloId',fld:'ARTICULOID'}],oparms:[{av:'AV13pArticuloId',fld:'vPARTICULOID'}]}");
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      lV6cArticuloId = "" ;
      H00112_A35CfgComprobanteDetalleLetra = new byte[1] ;
      H00112_A55ComprobanteNumero = new int[1] ;
      H00112_A32CfgComprobantePrefijo = new short[1] ;
      H00112_A31CfgComprobanteId = new String[] {""} ;
      H00112_A81EntidadId = new int[1] ;
      H00112_A42EmpresaId = new int[1] ;
      H00112_A66ComprobanteArticuloTotal = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00112_A65ComprobanteArticuloPrecioUnit = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00112_A64ComprobanteArticuloCantidad = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H00112_A39ArticuloId = new String[] {""} ;
      H00113_AGRID1_nRecordCount = new long[1] ;
      AV14ADVANCED_LABEL_TEMPLATE = "" ;
      Grid1Row = new com.genexus.webpanels.GXWebRow();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kberp.gx0106__default(),
         new Object[] {
             new Object[] {
            H00112_A35CfgComprobanteDetalleLetra, H00112_A55ComprobanteNumero, H00112_A32CfgComprobantePrefijo, H00112_A31CfgComprobanteId, H00112_A81EntidadId, H00112_A42EmpresaId, H00112_A66ComprobanteArticuloTotal, H00112_A65ComprobanteArticuloPrecioUnit, H00112_A64ComprobanteArticuloCantidad, H00112_A39ArticuloId
            }
            , new Object[] {
   ...
   private byte[] H00112_A35CfgComprobanteDetalleLetra ;
   private int[] H00112_A55ComprobanteNumero ;
   private short[] H00112_A32CfgComprobantePrefijo ;
   private String[] H00112_A31CfgComprobanteId ;
   private int[] H00112_A81EntidadId ;
   private int[] H00112_A42EmpresaId ;
   private java.math.BigDecimal[] H00112_A66ComprobanteArticuloTotal ;
   private java.math.BigDecimal[] H00112_A65ComprobanteArticuloPrecioUnit ;
   private java.math.BigDecimal[] H00112_A64ComprobanteArticuloCantidad ;
   private String[] H00112_A39ArticuloId ;
   private long[] H00113_AGRID1_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class gx0106__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H00112", "SELECT CfgComprobanteDetalleLetra, ComprobanteNumero, CfgComprobantePrefijo, CfgComprobanteId, EntidadId, EmpresaId, ComprobanteArticuloTotal, ComprobanteArticuloPrecioUnit, ComprobanteArticuloCantidad, ArticuloId FROM ComprobanteArticulo WHERE (EmpresaId = ? and EntidadId = ? and CfgComprobanteId = ( ?) and CfgComprobantePrefijo = ? and ComprobanteNumero = ? and CfgComprobanteDetalleLetra = ?) AND (ArticuloId like ?) ORDER BY EmpresaId, EntidadId, CfgComprobanteId, CfgComprobantePrefijo, ComprobanteNumero, CfgComprobanteDetalleLetra, ArticuloId  OFFSET ? LIMIT CASE WHEN ? > 0 THEN ? ELSE 1e9 END",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00113", "SELECT COUNT(*) FROM ComprobanteArticulo WHERE (EmpresaId = ? and EntidadId = ? and CfgComprobanteId = ( ?) and CfgComprobantePrefijo = ? and ComprobanteNumero = ? and CfgComprobanteDetalleLetra = ?) AND (ArticuloId like ?) ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
