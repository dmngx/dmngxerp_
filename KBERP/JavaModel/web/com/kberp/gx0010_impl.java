/*
       ...
       Generated on: February 19, 2017 17:32:15.72
...
public final  class gx0010_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV6cProvinciaId = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            gxgrgrid1_refresh( subGrid1_Rows, AV6cProvinciaId) ;
         ...
         {
            AV7pProvinciaId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV7pProvinciaId", GXutil.ltrim( GXutil.str( AV7pProvinciaId, 4, 0)));
         }
         if ( httpContext.isSpaRequest( ) )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201721917321576");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kberp.gx0010") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7pProvinciaId,4,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm( )
   {
      ...
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "GXH_vCPROVINCIAID", GXutil.ltrim( localUtil.ntoc( AV6cProvinciaId, (byte)(4), (byte)(0), ",", "")));
      /* Send saved values. */
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_24", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_24, (byte)(4), (byte)(0), ",", "")));
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "vPPROVINCIAID", GXutil.ltrim( localUtil.ntoc( AV7pProvinciaId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.kberp.gx0010") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7pProvinciaId,4,0))) ;
   }
   ...
   public void wb090( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblprovinciaidfilter_Internalname, "Provincia Id", "", "", lblLblprovinciaidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11091_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0010.htm");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCprovinciaid_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cProvinciaId, (byte)(4), (byte)(0), ",", "")), ((edtavCprovinciaid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV6cProvinciaId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV6cProvinciaId), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprovinciaid_Jsonclick, 0, "Attribute", "", "", "", edtavCprovinciaid_Visible, edtavCprovinciaid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx0010.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e12091_client"+"'", TempTags, "", 2, "HLP_Gx0010.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 24 )
      {
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0010.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start092( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selection List Provincia", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCPROVINCIAID"), ",", ".") != AV6cProvinciaId )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void rf092( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H00092 */
         pr_default.execute(0, new Object[] {new Short(AV6cProvinciaId), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_24_idx = (short)(1) ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_24_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subgrid1_recordsperpage( ) ) ) ) )
         {
            A1ProvinciaId = H00092_A1ProvinciaId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtProvinciaId_Internalname, GXutil.ltrim( GXutil.str( A1ProvinciaId, 4, 0)));
            /* Execute user event: Load */
            e14092 ();
   ...
   {
      /* Using cursor H00093 */
      pr_default.execute(1, new Object[] {new Short(AV6cProvinciaId)});
   ...
   public void strup090( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCprovinciaid_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCprovinciaid_Internalname), ",", ".") > 9999 ) ) )
         {
            ...
            wbErr = true ;
            AV6cProvinciaId = (short)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cProvinciaId", GXutil.ltrim( GXutil.str( AV6cProvinciaId, 4, 0)));
         }
         else
         {
            AV6cProvinciaId = (short)(localUtil.ctol( httpContext.cgiGet( edtavCprovinciaid_Internalname), ",", ".")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cProvinciaId", GXutil.ltrim( GXutil.str( AV6cProvinciaId, 4, 0)));
         }
         /* Read saved values. */
   ...
   {
      /* Start Routine */
      Form.setCaption( GXutil.format( "Lista de Selección %1", "Provincia", "", "", "", "", "", "", "", "") );
   ...
   {
      /* Enter Routine */
      AV7pProvinciaId = A1ProvinciaId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV7pProvinciaId", GXutil.ltrim( GXutil.str( AV7pProvinciaId, 4, 0)));
      httpContext.setWebReturnParms(new Object[] {new Short(AV7pProvinciaId)});
   ...
   {
      AV7pProvinciaId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV7pProvinciaId", GXutil.ltrim( GXutil.str( AV7pProvinciaId, 4, 0)));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201721917321643");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0010.js", "?201721917321644");
   ...
   public void subsflControlProps_242( )
   {
      ...
      edtProvinciaId_Internalname = "PROVINCIAID_"+sGXsfl_24_idx ;
   }

   public void subsflControlProps_fel_242( )
   {
      edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_24_fel_idx ;
      edtProvinciaId_Internalname = "PROVINCIAID_"+sGXsfl_24_fel_idx ;
   }
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A1ProvinciaId, (byte)(4), (byte)(0), ",", "")))+"'"+"]);" ;
         ...
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtProvinciaId_Internalname,GXutil.ltrim( localUtil.ntoc( A1ProvinciaId, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A1ProvinciaId), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtProvinciaId_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(24),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"IdTablasGenerales","right"});
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List Provincia" );
      subGrid1_Rows = 10 ;
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cProvinciaId',fld:'vCPROVINCIAID'}],oparms:[]}");
      setEventMetadata("'TOGGLE'","{handler:'e12091',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLPROVINCIAIDFILTER.CLICK","{handler:'e11091',iparms:[{av:'divProvinciaidfiltercontainer_Class',ctrl:'PROVINCIAIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divProvinciaidfiltercontainer_Class',ctrl:'PROVINCIAIDFILTERCONTAINER',prop:'Class'},{av:'edtavCprovinciaid_Visible',ctrl:'vCPROVINCIAID',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e15092',iparms:[{av:'A1ProvinciaId',fld:'PROVINCIAID'}],oparms:[{av:'AV7pProvinciaId',fld:'vPPROVINCIAID'}]}");
      setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cProvinciaId',fld:'vCPROVINCIAID'}],oparms:[]}");
      setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cProvinciaId',fld:'vCPROVINCIAID'}],oparms:[]}");
      setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cProvinciaId',fld:'vCPROVINCIAID'}],oparms:[]}");
      setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cProvinciaId',fld:'vCPROVINCIAID'}],oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H00092_A1ProvinciaId = new short[1] ;
      H00093_AGRID1_nRecordCount = new long[1] ;
      AV8ADVANCED_LABEL_TEMPLATE = "" ;
      Grid1Row = new com.genexus.webpanels.GXWebRow();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kberp.gx0010__default(),
         new Object[] {
             new Object[] {
            H00092_A1ProvinciaId
            }
            , new Object[] {
   ...
   private short AV6cProvinciaId ;
   private short AV7pProvinciaId ;
   private short wbEnd ;
   ...
   private short[] H00092_A1ProvinciaId ;
...
final  class gx0010__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00092", "SELECT ProvinciaId FROM Provincia WHERE ProvinciaId >= ? ORDER BY ProvinciaId  OFFSET ? LIMIT CASE WHEN ? > 0 THEN ? ELSE 1e9 END",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00093", "SELECT COUNT(*) FROM Provincia WHERE ProvinciaId >= ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
