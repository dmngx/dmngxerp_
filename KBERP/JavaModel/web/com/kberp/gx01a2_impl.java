...
public final  class gx01a2_impl extends GXDataArea
{
   public gx01a2_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gx01a2_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gx01a2_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201721917323662");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kberp.gx01a2") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV11pEmpresaId,6,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV12pEntidadId,6,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pEntidadDomicilioId,4,0)))+"\">") ;
   ...
   {
      return formatLink("com.kberp.gx01a2") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV11pEmpresaId,6,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV12pEntidadId,6,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pEntidadDomicilioId,4,0))) ;
   }
   ...
   public void wb170( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomicilioidfilter_Internalname, "Entidad Domicilio Id", "", "", lblLblentidaddomicilioidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11171_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx01A2.htm");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomicilionumerofilter_Internalname, "Entidad Domicilio Numero", "", "", lblLblentidaddomicilionumerofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12171_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx01A2.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomiciliopisofilter_Internalname, "Entidad Domicilio Piso", "", "", lblLblentidaddomiciliopisofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13171_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx01A2.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCentidaddomiciliopiso_Internalname, GXutil.ltrim( localUtil.ntoc( AV8cEntidadDomicilioPiso, (byte)(3), (byte)(0), ",", "")), ((edtavCentidaddomiciliopiso_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV8cEntidadDomicilioPiso), "ZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV8cEntidadDomicilioPiso), "ZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCentidaddomiciliopiso_Jsonclick, 0, "Attribute", "", "", "", edtavCentidaddomiciliopiso_Visible, edtavCentidaddomiciliopiso_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx01A2.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomiciliodeptofilter_Internalname, "Entidad Domicilio Depto", "", "", lblLblentidaddomiciliodeptofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14171_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx01A2.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCentidaddomiciliodepto_Internalname, AV9cEntidadDomicilioDepto, GXutil.rtrim( localUtil.format( AV9cEntidadDomicilioDepto, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCentidaddomiciliodepto_Jsonclick, 0, "Attribute", "", "", "", edtavCentidaddomiciliodepto_Visible, edtavCentidaddomiciliodepto_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_Gx01A2.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomiciliocpostalfilter_Internalname, "Entidad Domicilio CPostal", "", "", lblLblentidaddomiciliocpostalfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15171_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx01A2.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 64, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e16171_client"+"'", TempTags, "", 2, "HLP_Gx01A2.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 64 )
      {
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 64, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx01A2.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void rf172( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A81EntidadId = H00172_A81EntidadId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadId_Internalname, GXutil.ltrim( GXutil.str( A81EntidadId, 6, 0)));
            A42EmpresaId = H00172_A42EmpresaId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEmpresaId_Internalname, GXutil.ltrim( GXutil.str( A42EmpresaId, 6, 0)));
            A89EntidadDomicilioCPostal = H00172_A89EntidadDomicilioCPostal[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioCPostal_Internalname, A89EntidadDomicilioCPostal);
            A88EntidadDomicilioDepto = H00172_A88EntidadDomicilioDepto[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioDepto_Internalname, A88EntidadDomicilioDepto);
            A87EntidadDomicilioPiso = H00172_A87EntidadDomicilioPiso[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioPiso_Internalname, GXutil.ltrim( GXutil.str( A87EntidadDomicilioPiso, 3, 0)));
            A86EntidadDomicilioNumero = H00172_A86EntidadDomicilioNumero[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioNumero_Internalname, GXutil.ltrim( GXutil.str( A86EntidadDomicilioNumero, 6, 0)));
            A84EntidadDomicilioId = H00172_A84EntidadDomicilioId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioId_Internalname, GXutil.ltrim( GXutil.str( A84EntidadDomicilioId, 4, 0)));
            /* Execute user event: Load */
            e18172 ();
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201721917323823");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx01a2.js", "?201721917323823");
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'TOGGLE'","{handler:'e16171',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLENTIDADDOMICILIOIDFILTER.CLICK","{handler:'e11171',iparms:[{av:'divEntidaddomicilioidfiltercontainer_Class',ctrl:'ENTIDADDOMICILIOIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomicilioidfiltercontainer_Class',ctrl:'ENTIDADDOMICILIOIDFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomicilioid_Visible',ctrl:'vCENTIDADDOMICILIOID',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADDOMICILIONUMEROFILTER.CLICK","{handler:'e12171',iparms:[{av:'divEntidaddomicilionumerofiltercontainer_Class',ctrl:'ENTIDADDOMICILIONUMEROFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomicilionumerofiltercontainer_Class',ctrl:'ENTIDADDOMICILIONUMEROFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomicilionumero_Visible',ctrl:'vCENTIDADDOMICILIONUMERO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADDOMICILIOPISOFILTER.CLICK","{handler:'e13171',iparms:[{av:'divEntidaddomiciliopisofiltercontainer_Class',ctrl:'ENTIDADDOMICILIOPISOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomiciliopisofiltercontainer_Class',ctrl:'ENTIDADDOMICILIOPISOFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomiciliopiso_Visible',ctrl:'vCENTIDADDOMICILIOPISO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADDOMICILIODEPTOFILTER.CLICK","{handler:'e14171',iparms:[{av:'divEntidaddomiciliodeptofiltercontainer_Class',ctrl:'ENTIDADDOMICILIODEPTOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomiciliodeptofiltercontainer_Class',ctrl:'ENTIDADDOMICILIODEPTOFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomiciliodepto_Visible',ctrl:'vCENTIDADDOMICILIODEPTO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADDOMICILIOCPOSTALFILTER.CLICK","{handler:'e15171',iparms:[{av:'divEntidaddomiciliocpostalfiltercontainer_Class',ctrl:'ENTIDADDOMICILIOCPOSTALFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomiciliocpostalfiltercontainer_Class',ctrl:'ENTIDADDOMICILIOCPOSTALFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomiciliocpostal_Visible',ctrl:'vCENTIDADDOMICILIOCPOSTAL',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e19172',iparms:[{av:'A84EntidadDomicilioId',fld:'ENTIDADDOMICILIOID'}],oparms:[{av:'AV13pEntidadDomicilioId',fld:'vPENTIDADDOMICILIOID'}]}");
   ...
   public void initialize( )
   {
      ...
      H00172_A81EntidadId = new int[1] ;
      H00172_A42EmpresaId = new int[1] ;
      H00172_A89EntidadDomicilioCPostal = new String[] {""} ;
      H00172_A88EntidadDomicilioDepto = new String[] {""} ;
      H00172_A87EntidadDomicilioPiso = new short[1] ;
      H00172_A86EntidadDomicilioNumero = new int[1] ;
      H00172_A84EntidadDomicilioId = new short[1] ;
      H00173_AGRID1_nRecordCount = new long[1] ;
      AV14ADVANCED_LABEL_TEMPLATE = "" ;
      Grid1Row = new com.genexus.webpanels.GXWebRow();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kberp.gx01a2__default(),
         new Object[] {
             new Object[] {
            H00172_A81EntidadId, H00172_A42EmpresaId, H00172_A89EntidadDomicilioCPostal, H00172_A88EntidadDomicilioDepto, H00172_A87EntidadDomicilioPiso, H00172_A86EntidadDomicilioNumero, H00172_A84EntidadDomicilioId
            }
            , new Object[] {
   ...
   private int[] H00172_A81EntidadId ;
   private int[] H00172_A42EmpresaId ;
   private String[] H00172_A89EntidadDomicilioCPostal ;
   private String[] H00172_A88EntidadDomicilioDepto ;
   private short[] H00172_A87EntidadDomicilioPiso ;
   private int[] H00172_A86EntidadDomicilioNumero ;
   private short[] H00172_A84EntidadDomicilioId ;
   private long[] H00173_AGRID1_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class gx01a2__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H00172", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H00173", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
