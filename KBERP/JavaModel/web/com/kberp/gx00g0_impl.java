/*
       ...
       Generated on: February 14, 2017 1:17:53.1
...
public final  class gx00g0_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20172141175314");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kberp.gx00g0") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pEntidadId,6,0)))+"\">") ;
   ...
   {
      return formatLink("com.kberp.gx00g0") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pEntidadId,6,0))) ;
   }
   ...
   public void wb0L0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidadidfilter_Internalname, "Entidad Id", "", "", lblLblentidadidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110l1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00G0.htm");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCentidadid_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cEntidadId, (byte)(6), (byte)(0), ",", "")), ((edtavCentidadid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV6cEntidadId), "ZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV6cEntidadId), "ZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCentidadid_Jsonclick, 0, "Attribute", "", "", "", edtavCentidadid_Visible, edtavCentidadid_Enabled, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidadnumerodocumentofilter_Internalname, "Entidad Numero Documento", "", "", lblLblentidadnumerodocumentofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120l1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidadnumerofilter_Internalname, "Entidad Numero", "", "", lblLblentidadnumerofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130l1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCentidadnumero_Internalname, GXutil.ltrim( localUtil.ntoc( AV8cEntidadNumero, (byte)(6), (byte)(0), ",", "")), ((edtavCentidadnumero_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV8cEntidadNumero), "ZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV8cEntidadNumero), "ZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCentidadnumero_Jsonclick, 0, "Attribute", "", "", "", edtavCentidadnumero_Visible, edtavCentidadnumero_Enabled, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidadpisofilter_Internalname, "Entidad Piso", "", "", lblLblentidadpisofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e140l1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddeptofilter_Internalname, "Entidad Depto", "", "", lblLblentidaddeptofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e150l1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCentidaddepto_Internalname, GXutil.rtrim( AV10cEntidadDepto), GXutil.rtrim( localUtil.format( AV10cEntidadDepto, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCentidaddepto_Jsonclick, 0, "Attribute", "", "", "", edtavCentidaddepto_Visible, edtavCentidaddepto_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidadcpostalfilter_Internalname, "Entidad CPostal", "", "", lblLblentidadcpostalfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e160l1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLbllocalidadidfilter_Internalname, "Localidad Id", "", "", lblLbllocalidadidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e170l1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e180l1_client"+"'", TempTags, "", 2, "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 84 )
      {
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx00G0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void rf0L2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A1ProvinciaId = H000L2_A1ProvinciaId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtProvinciaId_Internalname, GXutil.ltrim( GXutil.str( A1ProvinciaId, 4, 0)));
            A3PaisId = H000L2_A3PaisId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtPaisId_Internalname, GXutil.ltrim( GXutil.str( A3PaisId, 4, 0)));
            A5LocalidadId = H000L2_A5LocalidadId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtLocalidadId_Internalname, GXutil.ltrim( GXutil.str( A5LocalidadId, 4, 0)));
            A26EntidadCPostal = H000L2_A26EntidadCPostal[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadCPostal_Internalname, A26EntidadCPostal);
            A25EntidadDepto = H000L2_A25EntidadDepto[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDepto_Internalname, A25EntidadDepto);
            A24EntidadPiso = H000L2_A24EntidadPiso[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadPiso_Internalname, GXutil.ltrim( GXutil.str( A24EntidadPiso, 3, 0)));
            A23EntidadNumero = H000L2_A23EntidadNumero[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadNumero_Internalname, GXutil.ltrim( GXutil.str( A23EntidadNumero, 6, 0)));
            A29EntidadNumeroDocumento = H000L2_A29EntidadNumeroDocumento[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadNumeroDocumento_Internalname, A29EntidadNumeroDocumento);
            A20EntidadId = H000L2_A20EntidadId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadId_Internalname, GXutil.ltrim( GXutil.str( A20EntidadId, 6, 0)));
            /* Execute user event: Load */
            e200L2 ();
   ...
   {
      httpContext.AddThemeStyleSheetFile("", context.getHttpContext().getTheme( )+".css", "?2115327");
      idxLst = 1 ;
      while ( idxLst <= Form.getJscriptsrc().getCount() )
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20172141175560");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx00g0.js", "?20172141175560");
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("LBLENTIDADIDFILTER.CLICK","{handler:'e110L1',iparms:[{av:'divEntidadidfiltercontainer_Class',ctrl:'ENTIDADIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidadidfiltercontainer_Class',ctrl:'ENTIDADIDFILTERCONTAINER',prop:'Class'},{av:'edtavCentidadid_Visible',ctrl:'vCENTIDADID',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADNUMERODOCUMENTOFILTER.CLICK","{handler:'e120L1',iparms:[{av:'divEntidadnumerodocumentofiltercontainer_Class',ctrl:'ENTIDADNUMERODOCUMENTOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidadnumerodocumentofiltercontainer_Class',ctrl:'ENTIDADNUMERODOCUMENTOFILTERCONTAINER',prop:'Class'},{av:'edtavCentidadnumerodocumento_Visible',ctrl:'vCENTIDADNUMERODOCUMENTO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADNUMEROFILTER.CLICK","{handler:'e130L1',iparms:[{av:'divEntidadnumerofiltercontainer_Class',ctrl:'ENTIDADNUMEROFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidadnumerofiltercontainer_Class',ctrl:'ENTIDADNUMEROFILTERCONTAINER',prop:'Class'},{av:'edtavCentidadnumero_Visible',ctrl:'vCENTIDADNUMERO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADPISOFILTER.CLICK","{handler:'e140L1',iparms:[{av:'divEntidadpisofiltercontainer_Class',ctrl:'ENTIDADPISOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidadpisofiltercontainer_Class',ctrl:'ENTIDADPISOFILTERCONTAINER',prop:'Class'},{av:'edtavCentidadpiso_Visible',ctrl:'vCENTIDADPISO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADDEPTOFILTER.CLICK","{handler:'e150L1',iparms:[{av:'divEntidaddeptofiltercontainer_Class',ctrl:'ENTIDADDEPTOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddeptofiltercontainer_Class',ctrl:'ENTIDADDEPTOFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddepto_Visible',ctrl:'vCENTIDADDEPTO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADCPOSTALFILTER.CLICK","{handler:'e160L1',iparms:[{av:'divEntidadcpostalfiltercontainer_Class',ctrl:'ENTIDADCPOSTALFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidadcpostalfiltercontainer_Class',ctrl:'ENTIDADCPOSTALFILTERCONTAINER',prop:'Class'},{av:'edtavCentidadcpostal_Visible',ctrl:'vCENTIDADCPOSTAL',prop:'Visible'}]}");
      setEventMetadata("LBLLOCALIDADIDFILTER.CLICK","{handler:'e170L1',iparms:[{av:'divLocalidadidfiltercontainer_Class',ctrl:'LOCALIDADIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divLocalidadidfiltercontainer_Class',ctrl:'LOCALIDADIDFILTERCONTAINER',prop:'Class'},{av:'edtavClocalidadid_Visible',ctrl:'vCLOCALIDADID',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e210L2',iparms:[{av:'A20EntidadId',fld:'ENTIDADID'}],oparms:[{av:'AV13pEntidadId',fld:'vPENTIDADID'}]}");
   ...
   public void initialize( )
   {
      ...
      lV10cEntidadDepto = "" ;
      lV11cEntidadCPostal = "" ;
      H000L2_A1ProvinciaId = new short[1] ;
      H000L2_A3PaisId = new short[1] ;
      H000L2_A5LocalidadId = new short[1] ;
      H000L2_A26EntidadCPostal = new String[] {""} ;
      H000L2_A25EntidadDepto = new String[] {""} ;
      H000L2_A24EntidadPiso = new short[1] ;
      H000L2_A23EntidadNumero = new int[1] ;
      H000L2_A29EntidadNumeroDocumento = new String[] {""} ;
      H000L2_A20EntidadId = new int[1] ;
      H000L3_AGRID1_nRecordCount = new long[1] ;
      AV14ADVANCED_LABEL_TEMPLATE = "" ;
      Grid1Row = new com.genexus.webpanels.GXWebRow();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kberp.gx00g0__default(),
         new Object[] {
             new Object[] {
            H000L2_A1ProvinciaId, H000L2_A3PaisId, H000L2_A5LocalidadId, H000L2_A26EntidadCPostal, H000L2_A25EntidadDepto, H000L2_A24EntidadPiso, H000L2_A23EntidadNumero, H000L2_A29EntidadNumeroDocumento, H000L2_A20EntidadId
            }
            , new Object[] {
   ...
   private short[] H000L2_A1ProvinciaId ;
   private short[] H000L2_A3PaisId ;
   private short[] H000L2_A5LocalidadId ;
   private String[] H000L2_A26EntidadCPostal ;
   private String[] H000L2_A25EntidadDepto ;
   private short[] H000L2_A24EntidadPiso ;
   private int[] H000L2_A23EntidadNumero ;
   private String[] H000L2_A29EntidadNumeroDocumento ;
   private int[] H000L2_A20EntidadId ;
...
{
   protected Object[] conditional_H000L2( ModelContext context ,
                                          int remoteHandle ,
   ...
   protected Object[] conditional_H000L3( ModelContext context ,
                                          int remoteHandle ,
                                          com.genexus.internet.HttpContext httpContext ,
                                          String AV7cEntidadNumeroDocumento ,
                                          int AV8cEntidadNumero ,
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000L2(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).shortValue() , (String)dynConstraints[9] , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Number) dynConstraints[12]).intValue() );
            case 1 :
                  return conditional_H000L3(context, remoteHandle, httpContext, (String)dynConstraints[0] , ((Number) dynConstraints[1]).intValue() , ((Number) dynConstraints[2]).shortValue() , (String)dynConstraints[3] , (String)dynConstraints[4] , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] , ((Number) dynConstraints[7]).intValue() , ((Number) dynConstraints[8]).shortValue() , (String)dynConstraints[9] , (String)dynConstraints[10] , ((Number) dynConstraints[11]).shortValue() , ((Number) dynConstraints[12]).intValue() );
      }
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000L2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H000L3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
