...
public final  class gx00j0_impl extends GXDataArea
{
   public gx00j0_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gx00j0_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gx00j0_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV16cTipoDocumentoId = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            AV17cCondicionCpraVtaId = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            AV18cEntidadTipo = (byte)(GXutil.lval( httpContext.GetNextPar( ))) ;
            AV19cEntidadActiva = (boolean)(GXutil.boolval(httpContext.GetNextPar( ))) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            gxgrgrid1_refresh( subGrid1_Rows, AV6cEntidadId, AV7cEmpresaId, AV8cEntidadNumeroDocumento, AV16cTipoDocumentoId, AV17cCondicionCpraVtaId, AV18cEntidadTipo, AV19cEntidadActiva) ;
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV14pEmpresaId = (int)(GXutil.lval( httpContext.GetNextPar( ))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV14pEmpresaId", GXutil.ltrim( GXutil.str( AV14pEmpresaId, 6, 0)));
            }
         }
         if ( httpContext.isSpaRequest( ) )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20172181255741");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kberp.gx00j0") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pEntidadId,6,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV14pEmpresaId,6,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm( )
   {
      ...
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "GXH_vCTIPODOCUMENTOID", GXutil.ltrim( localUtil.ntoc( AV16cTipoDocumentoId, (byte)(4), (byte)(0), ",", "")));
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "GXH_vCCONDICIONCPRAVTAID", GXutil.ltrim( localUtil.ntoc( AV17cCondicionCpraVtaId, (byte)(4), (byte)(0), ",", "")));
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "GXH_vCENTIDADTIPO", GXutil.ltrim( localUtil.ntoc( AV18cEntidadTipo, (byte)(2), (byte)(0), ",", "")));
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "GXH_vCENTIDADACTIVA", GXutil.booltostr( AV19cEntidadActiva));
      /* Send saved values. */
      ...
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "vPEMPRESAID", GXutil.ltrim( localUtil.ntoc( AV14pEmpresaId, (byte)(6), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.kberp.gx00j0") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pEntidadId,6,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV14pEmpresaId,6,0))) ;
   }
   ...
   public void wb0N0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidadidfilter_Internalname, "Entidad Id", "", "", lblLblentidadidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00J0.htm");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCentidadid_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cEntidadId, (byte)(6), (byte)(0), ",", "")), ((edtavCentidadid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV6cEntidadId), "ZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV6cEntidadId), "ZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCentidadid_Jsonclick, 0, "Attribute", "", "", "", edtavCentidadid_Visible, edtavCentidadid_Enabled, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblempresaidfilter_Internalname, "Empresa Id", "", "", lblLblempresaidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCempresaid_Internalname, GXutil.ltrim( localUtil.ntoc( AV7cEmpresaId, (byte)(6), (byte)(0), ",", "")), ((edtavCempresaid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV7cEmpresaId), "ZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV7cEmpresaId), "ZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCempresaid_Jsonclick, 0, "Attribute", "", "", "", edtavCempresaid_Visible, edtavCempresaid_Enabled, 0, "text", "", 6, "chr", 1, "row", 6, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidadnumerodocumentofilter_Internalname, "Entidad Numero Documento", "", "", lblLblentidadnumerodocumentofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLbltipodocumentoidfilter_Internalname, "Tipo Documento Id", "", "", lblLbltipodocumentoidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e140n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCtipodocumentoid_Internalname, GXutil.ltrim( localUtil.ntoc( AV16cTipoDocumentoId, (byte)(4), (byte)(0), ",", "")), ((edtavCtipodocumentoid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV16cTipoDocumentoId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV16cTipoDocumentoId), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtipodocumentoid_Jsonclick, 0, "Attribute", "", "", "", edtavCtipodocumentoid_Visible, edtavCtipodocumentoid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblcondicioncpravtaidfilter_Internalname, "Condicion Cpra Vta Id", "", "", lblLblcondicioncpravtaidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e150n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCcondicioncpravtaid_Internalname, GXutil.ltrim( localUtil.ntoc( AV17cCondicionCpraVtaId, (byte)(4), (byte)(0), ",", "")), ((edtavCcondicioncpravtaid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV17cCondicionCpraVtaId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV17cCondicionCpraVtaId), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcondicioncpravtaid_Jsonclick, 0, "Attribute", "", "", "", edtavCcondicioncpravtaid_Visible, edtavCcondicioncpravtaid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidadtipofilter_Internalname, "Entidad Tipo", "", "", lblLblentidadtipofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e160n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         /* ComboBox */
         com.kberp.GxWebStd.gx_combobox_ctrl1( httpContext, cmbavCentidadtipo, cmbavCentidadtipo.getInternalname(), GXutil.trim( GXutil.str( AV18cEntidadTipo, 2, 0)), 1, cmbavCentidadtipo.getJsonclick(), 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", cmbavCentidadtipo.getVisible(), cmbavCentidadtipo.getEnabled(), 0, (short)(0), 0, "em", 0, "", "", "Attribute", "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "", true, "HLP_Gx00J0.htm");
         cmbavCentidadtipo.setValue( GXutil.trim( GXutil.str( AV18cEntidadTipo, 2, 0)) );
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidadactivafilter_Internalname, "Entidad Activa", "", "", lblLblentidadactivafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e170n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_checkbox_ctrl( httpContext, chkavCentidadactiva.getInternalname(), GXutil.booltostr( AV19cEntidadActiva), "", "Entidad Activa", chkavCentidadactiva.getVisible(), chkavCentidadactiva.getEnabled(), "true", "", StyleString, ClassString, "", TempTags+" onclick=\"gx.fn.checkboxClick(76, this, 'true', 'false');gx.evt.onchange(this);\" "+" onblur=\""+""+";gx.evt.onblur(this,76);\"");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e180n1_client"+"'", TempTags, "", 2, "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
            Grid1Column.AddObjectProperty("Value", GXutil.booltostr( A30EntidadActiva));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      if ( wbEnd == 84 )
      {
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx00J0.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 4), "LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           A30EntidadActiva = GXutil.strtobool( httpContext.cgiGet( chkEntidadActiva.getInternalname())) ;
                           httpContext.ajax_rsp_assign_attri("", false, chkEntidadActiva.getInternalname(), A30EntidadActiva);
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCTIPODOCUMENTOID"), ",", ".") != AV16cTipoDocumentoId )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Ccondicioncpravtaid Changed */
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCCONDICIONCPRAVTAID"), ",", ".") != AV17cCondicionCpraVtaId )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Centidadtipo Changed */
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCENTIDADTIPO"), ",", ".") != AV18cEntidadTipo )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    /* Set Refresh If Centidadactiva Changed */
                                    if ( GXutil.strtobool( httpContext.cgiGet( "GXH_vCENTIDADACTIVA")) != AV19cEntidadActiva )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void pa0N2( )
   {
      if ( nDonePA == 0 )
      {
         ...
         {
            AV18cEntidadTipo = (byte)(GXutil.lval( cmbavCentidadtipo.getValidValue(GXutil.trim( GXutil.str( AV18cEntidadTipo, 2, 0))))) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV18cEntidadTipo", GXutil.ltrim( GXutil.str( AV18cEntidadTipo, 2, 0)));
         }
   ...
   public void gxgrgrid1_refresh( int subGrid1_Rows ,
                                  ...
                                  short AV16cTipoDocumentoId ,
                                  short AV17cCondicionCpraVtaId ,
                                  byte AV18cEntidadTipo ,
                                  boolean AV19cEntidadActiva )
   {
      initialize_formulas( ) ;
      com.kberp.GxWebStd.set_html_headers( httpContext, 0, "", "");
   ...
   public void rf0N2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new Short(AV16cTipoDocumentoId) ,
                                              new Short(AV17cCondicionCpraVtaId) ,
                                              new Byte(AV18cEntidadTipo) ,
                                              new Boolean(AV19cEntidadActiva) ,
                                              A29EntidadNumeroDocumento ,
                                              new Short(A9TipoDocumentoId) ,
                                              new Short(A15CondicionCpraVtaId) ,
                                              new Byte(A27EntidadTipo) ,
                                              new Boolean(A30EntidadActiva) ,
         ...
         /* Using cursor H000N2 */
         pr_default.execute(0, new Object[] {new Integer(AV6cEntidadId), new Integer(AV7cEmpresaId), lV8cEntidadNumeroDocumento, new Short(AV16cTipoDocumentoId), new Short(AV17cCondicionCpraVtaId), new Byte(AV18cEntidadTipo), new Boolean(AV19cEntidadActiva), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_84_idx = (short)(1) ;
         sGXsfl_84_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_84_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_842( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subgrid1_recordsperpage( ) ) ) ) )
         {
            A30EntidadActiva = H000N2_A30EntidadActiva[0] ;
            httpContext.ajax_rsp_assign_attri("", false, chkEntidadActiva.getInternalname(), A30EntidadActiva);
            A27EntidadTipo = H000N2_A27EntidadTipo[0] ;
            httpContext.ajax_rsp_assign_attri("", false, cmbEntidadTipo.getInternalname(), GXutil.ltrim( GXutil.str( A27EntidadTipo, 2, 0)));
            A15CondicionCpraVtaId = H000N2_A15CondicionCpraVtaId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtCondicionCpraVtaId_Internalname, GXutil.ltrim( GXutil.str( A15CondicionCpraVtaId, 4, 0)));
            A9TipoDocumentoId = H000N2_A9TipoDocumentoId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtTipoDocumentoId_Internalname, GXutil.ltrim( GXutil.str( A9TipoDocumentoId, 4, 0)));
            A29EntidadNumeroDocumento = H000N2_A29EntidadNumeroDocumento[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadNumeroDocumento_Internalname, A29EntidadNumeroDocumento);
            A42EmpresaId = H000N2_A42EmpresaId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEmpresaId_Internalname, GXutil.ltrim( GXutil.str( A42EmpresaId, 6, 0)));
            A20EntidadId = H000N2_A20EntidadId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadId_Internalname, GXutil.ltrim( GXutil.str( A20EntidadId, 6, 0)));
            /* Execute user event: Load */
            e200N2 ();
   ...
   public int subgrid1_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV8cEntidadNumeroDocumento", AV8cEntidadNumeroDocumento);
      /* Using cursor H000N3 */
      pr_default.execute(1, new Object[] {new Integer(AV6cEntidadId), new Integer(AV7cEmpresaId), lV8cEntidadNumeroDocumento, new Short(AV16cTipoDocumentoId), new Short(AV17cCondicionCpraVtaId), new Byte(AV18cEntidadTipo), new Boolean(AV19cEntidadActiva)});
   ...
   public void strup0N0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCtipodocumentoid_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCtipodocumentoid_Internalname), ",", ".") > 9999 ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV16cTipoDocumentoId = (short)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV16cTipoDocumentoId", GXutil.ltrim( GXutil.str( AV16cTipoDocumentoId, 4, 0)));
         }
         else
         {
            AV16cTipoDocumentoId = (short)(localUtil.ctol( httpContext.cgiGet( edtavCtipodocumentoid_Internalname), ",", ".")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV16cTipoDocumentoId", GXutil.ltrim( GXutil.str( AV16cTipoDocumentoId, 4, 0)));
         }
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCcondicioncpravtaid_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCcondicioncpravtaid_Internalname), ",", ".") > 9999 ) ) )
         {
            ...
            httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
            wbErr = true ;
            AV17cCondicionCpraVtaId = (short)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV17cCondicionCpraVtaId", GXutil.ltrim( GXutil.str( AV17cCondicionCpraVtaId, 4, 0)));
         }
         else
         {
            AV17cCondicionCpraVtaId = (short)(localUtil.ctol( httpContext.cgiGet( edtavCcondicioncpravtaid_Internalname), ",", ".")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV17cCondicionCpraVtaId", GXutil.ltrim( GXutil.str( AV17cCondicionCpraVtaId, 4, 0)));
         }
         ...
         AV18cEntidadTipo = (byte)(GXutil.lval( httpContext.cgiGet( cmbavCentidadtipo.getInternalname()))) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV18cEntidadTipo", GXutil.ltrim( GXutil.str( AV18cEntidadTipo, 2, 0)));
         AV19cEntidadActiva = GXutil.strtobool( httpContext.cgiGet( chkavCentidadactiva.getInternalname())) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV19cEntidadActiva", AV19cEntidadActiva);
         /* Read saved values. */
   ...
   public void e210N2( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV13pEntidadId", GXutil.ltrim( GXutil.str( AV13pEntidadId, 6, 0)));
      AV14pEmpresaId = A42EmpresaId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14pEmpresaId", GXutil.ltrim( GXutil.str( AV14pEmpresaId, 6, 0)));
      httpContext.setWebReturnParms(new Object[] {new Integer(AV13pEntidadId),new Integer(AV14pEmpresaId)});
   ...
   public void setparameters( Object[] obj )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV13pEntidadId", GXutil.ltrim( GXutil.str( AV13pEntidadId, 6, 0)));
      AV14pEmpresaId = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV14pEmpresaId", GXutil.ltrim( GXutil.str( AV14pEmpresaId, 6, 0)));
   }
   ...
   {
      httpContext.AddThemeStyleSheetFile("", context.getHttpContext().getTheme( )+".css", "?1254321");
      idxLst = 1 ;
      while ( idxLst <= Form.getJscriptsrc().getCount() )
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20172181255935");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx00j0.js", "?20172181255936");
   ...
   public void sendrow_842( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         Grid1Row.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {chkEntidadActiva.getInternalname(),GXutil.booltostr( A30EntidadActiva),"","",new Integer(-1),new Integer(0),"true","",StyleString,ClassString,"WWColumn OptionalColumn",""});
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cEntidadId',fld:'vCENTIDADID'},{av:'AV7cEmpresaId',fld:'vCEMPRESAID'},{av:'AV8cEntidadNumeroDocumento',fld:'vCENTIDADNUMERODOCUMENTO'},{av:'AV16cTipoDocumentoId',fld:'vCTIPODOCUMENTOID'},{av:'AV17cCondicionCpraVtaId',fld:'vCCONDICIONCPRAVTAID'},{av:'cmbavCentidadtipo'},{av:'AV18cEntidadTipo',fld:'vCENTIDADTIPO'},{av:'AV19cEntidadActiva',fld:'vCENTIDADACTIVA'}],oparms:[]}");
      setEventMetadata("'TOGGLE'","{handler:'e180N1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLENTIDADIDFILTER.CLICK","{handler:'e110N1',iparms:[{av:'divEntidadidfiltercontainer_Class',ctrl:'ENTIDADIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidadidfiltercontainer_Class',ctrl:'ENTIDADIDFILTERCONTAINER',prop:'Class'},{av:'edtavCentidadid_Visible',ctrl:'vCENTIDADID',prop:'Visible'}]}");
      setEventMetadata("LBLEMPRESAIDFILTER.CLICK","{handler:'e120N1',iparms:[{av:'divEmpresaidfiltercontainer_Class',ctrl:'EMPRESAIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEmpresaidfiltercontainer_Class',ctrl:'EMPRESAIDFILTERCONTAINER',prop:'Class'},{av:'edtavCempresaid_Visible',ctrl:'vCEMPRESAID',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADNUMERODOCUMENTOFILTER.CLICK","{handler:'e130N1',iparms:[{av:'divEntidadnumerodocumentofiltercontainer_Class',ctrl:'ENTIDADNUMERODOCUMENTOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidadnumerodocumentofiltercontainer_Class',ctrl:'ENTIDADNUMERODOCUMENTOFILTERCONTAINER',prop:'Class'},{av:'edtavCentidadnumerodocumento_Visible',ctrl:'vCENTIDADNUMERODOCUMENTO',prop:'Visible'}]}");
      setEventMetadata("LBLTIPODOCUMENTOIDFILTER.CLICK","{handler:'e140N1',iparms:[{av:'divTipodocumentoidfiltercontainer_Class',ctrl:'TIPODOCUMENTOIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divTipodocumentoidfiltercontainer_Class',ctrl:'TIPODOCUMENTOIDFILTERCONTAINER',prop:'Class'},{av:'edtavCtipodocumentoid_Visible',ctrl:'vCTIPODOCUMENTOID',prop:'Visible'}]}");
      setEventMetadata("LBLCONDICIONCPRAVTAIDFILTER.CLICK","{handler:'e150N1',iparms:[{av:'divCondicioncpravtaidfiltercontainer_Class',ctrl:'CONDICIONCPRAVTAIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divCondicioncpravtaidfiltercontainer_Class',ctrl:'CONDICIONCPRAVTAIDFILTERCONTAINER',prop:'Class'},{av:'edtavCcondicioncpravtaid_Visible',ctrl:'vCCONDICIONCPRAVTAID',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADTIPOFILTER.CLICK","{handler:'e160N1',iparms:[{av:'divEntidadtipofiltercontainer_Class',ctrl:'ENTIDADTIPOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidadtipofiltercontainer_Class',ctrl:'ENTIDADTIPOFILTERCONTAINER',prop:'Class'},{av:'cmbavCentidadtipo'}]}");
      setEventMetadata("LBLENTIDADACTIVAFILTER.CLICK","{handler:'e170N1',iparms:[{av:'divEntidadactivafiltercontainer_Class',ctrl:'ENTIDADACTIVAFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidadactivafiltercontainer_Class',ctrl:'ENTIDADACTIVAFILTERCONTAINER',prop:'Class'},{av:'chkavCentidadactiva.getVisible()',ctrl:'vCENTIDADACTIVA',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e210N2',iparms:[{av:'A20EntidadId',fld:'ENTIDADID'},{av:'A42EmpresaId',fld:'EMPRESAID'}],oparms:[{av:'AV13pEntidadId',fld:'vPENTIDADID'},{av:'AV14pEmpresaId',fld:'vPEMPRESAID'}]}");
   ...
   public void initialize( )
   {
      ...
      AV18cEntidadTipo = (byte)(1) ;
      AV19cEntidadActiva = true ;
      ...
      H000N2_A30EntidadActiva = new boolean[] {false} ;
      H000N2_A27EntidadTipo = new byte[1] ;
      H000N2_A15CondicionCpraVtaId = new short[1] ;
      H000N2_A9TipoDocumentoId = new short[1] ;
      H000N2_A29EntidadNumeroDocumento = new String[] {""} ;
      H000N2_A42EmpresaId = new int[1] ;
      H000N2_A20EntidadId = new int[1] ;
      H000N3_AGRID1_nRecordCount = new long[1] ;
      AV15ADVANCED_LABEL_TEMPLATE = "" ;
      Grid1Row = new com.genexus.webpanels.GXWebRow();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kberp.gx00j0__default(),
         new Object[] {
             new Object[] {
            H000N2_A30EntidadActiva, H000N2_A27EntidadTipo, H000N2_A15CondicionCpraVtaId, H000N2_A9TipoDocumentoId, H000N2_A29EntidadNumeroDocumento, H000N2_A42EmpresaId, H000N2_A20EntidadId
            }
            , new Object[] {
   ...
   private short AV16cTipoDocumentoId ;
   private short AV17cCondicionCpraVtaId ;
   private short wbEnd ;
   ...
   private boolean AV19cEntidadActiva ;
   private boolean toggleJsOutput ;
   private boolean wbLoad ;
   private boolean A30EntidadActiva ;
   ...
   private boolean[] H000N2_A30EntidadActiva ;
   private byte[] H000N2_A27EntidadTipo ;
   private short[] H000N2_A15CondicionCpraVtaId ;
   private short[] H000N2_A9TipoDocumentoId ;
   private String[] H000N2_A29EntidadNumeroDocumento ;
   private int[] H000N2_A42EmpresaId ;
   private int[] H000N2_A20EntidadId ;
   private long[] H000N3_AGRID1_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class gx00j0__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          int AV7cEmpresaId )
   {
      ...
      sSelectString = sSelectString + " EmpresaId, EntidadId" ;
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000N2", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H000N3", "scmdbuf",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
