...
public final  class gx0171_impl extends GXDataArea
{
   public gx0171_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public gx0171_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( gx0171_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV11pEntidadId = (int)(GXutil.lval( httpContext.GetNextPar( ))) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            gxgrgrid1_refresh( subGrid1_Rows, AV6cEntidadDomicilioId, AV7cEntidadDomicilioNumero, AV8cEntidadDomicilioPiso, AV9cEntidadDomicilioDepto, AV10cEntidadDomicilioCPostal, AV11pEntidadId) ;
         ...
         {
            AV11pEntidadId = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV11pEntidadId", GXutil.ltrim( GXutil.str( AV11pEntidadId, 6, 0)));
            if ( GXutil.strcmp(gxfirstwebparm, "viewer") != 0 )
            {
               AV12pEntidadDomicilioId = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
               httpContext.ajax_rsp_assign_attri("", false, "AV12pEntidadDomicilioId", GXutil.ltrim( GXutil.str( AV12pEntidadDomicilioId, 4, 0)));
            }
         }
         if ( httpContext.isSpaRequest( ) )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20172191721217");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kberp.gx0171") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV11pEntidadId,6,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV12pEntidadDomicilioId,4,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm( )
   {
      ...
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "vPENTIDADID", GXutil.ltrim( localUtil.ntoc( AV11pEntidadId, (byte)(6), (byte)(0), ",", "")));
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "vPENTIDADDOMICILIOID", GXutil.ltrim( localUtil.ntoc( AV12pEntidadDomicilioId, (byte)(4), (byte)(0), ",", "")));
      ...
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPENTIDADID", getSecureSignedToken( "", String.valueOf(AV11pEntidadId)));
   ...
   {
      return formatLink("com.kberp.gx0171") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV11pEntidadId,6,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV12pEntidadDomicilioId,4,0))) ;
   }
   ...
   public void wb140( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomicilioidfilter_Internalname, "Entidad Domicilio Id", "", "", lblLblentidaddomicilioidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11141_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0171.htm");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomicilionumerofilter_Internalname, "Entidad Domicilio Numero", "", "", lblLblentidaddomicilionumerofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12141_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0171.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomiciliopisofilter_Internalname, "Entidad Domicilio Piso", "", "", lblLblentidaddomiciliopisofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13141_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0171.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCentidaddomiciliopiso_Internalname, GXutil.ltrim( localUtil.ntoc( AV8cEntidadDomicilioPiso, (byte)(3), (byte)(0), ",", "")), ((edtavCentidaddomiciliopiso_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV8cEntidadDomicilioPiso), "ZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV8cEntidadDomicilioPiso), "ZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCentidaddomiciliopiso_Jsonclick, 0, "Attribute", "", "", "", edtavCentidaddomiciliopiso_Visible, edtavCentidaddomiciliopiso_Enabled, 0, "text", "", 3, "chr", 1, "row", 3, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx0171.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomiciliodeptofilter_Internalname, "Entidad Domicilio Depto", "", "", lblLblentidaddomiciliodeptofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14141_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0171.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCentidaddomiciliodepto_Internalname, AV9cEntidadDomicilioDepto, GXutil.rtrim( localUtil.format( AV9cEntidadDomicilioDepto, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCentidaddomiciliodepto_Jsonclick, 0, "Attribute", "", "", "", edtavCentidaddomiciliodepto_Visible, edtavCentidaddomiciliodepto_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_Gx0171.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblentidaddomiciliocpostalfilter_Internalname, "Entidad Domicilio CPostal", "", "", lblLblentidaddomiciliocpostalfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15141_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0171.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 64, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e16141_client"+"'", TempTags, "", 2, "HLP_Gx0171.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 64 )
      {
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 64, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0171.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void rf142( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new Integer(AV11pEntidadId) ,
                                              new Short(AV6cEntidadDomicilioId) ,
                                              new Integer(A81EntidadId) } ,
                                              new int[]{
                                              TypeConstants.INT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.INT, TypeConstants.SHORT,
                                              TypeConstants.INT
                                              }
         } ) ;
         ...
         /* Using cursor H00142 */
         pr_default.execute(0, new Object[] {new Integer(AV11pEntidadId), new Short(AV6cEntidadDomicilioId), new Integer(AV7cEntidadDomicilioNumero), new Short(AV8cEntidadDomicilioPiso), lV9cEntidadDomicilioDepto, lV10cEntidadDomicilioCPostal, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_64_idx = (short)(1) ;
         sGXsfl_64_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_64_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_642( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subgrid1_recordsperpage( ) ) ) ) )
         {
            A81EntidadId = H00142_A81EntidadId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadId_Internalname, GXutil.ltrim( GXutil.str( A81EntidadId, 6, 0)));
            A89EntidadDomicilioCPostal = H00142_A89EntidadDomicilioCPostal[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioCPostal_Internalname, A89EntidadDomicilioCPostal);
            A88EntidadDomicilioDepto = H00142_A88EntidadDomicilioDepto[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioDepto_Internalname, A88EntidadDomicilioDepto);
            A87EntidadDomicilioPiso = H00142_A87EntidadDomicilioPiso[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioPiso_Internalname, GXutil.ltrim( GXutil.str( A87EntidadDomicilioPiso, 3, 0)));
            A86EntidadDomicilioNumero = H00142_A86EntidadDomicilioNumero[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioNumero_Internalname, GXutil.ltrim( GXutil.str( A86EntidadDomicilioNumero, 6, 0)));
            A84EntidadDomicilioId = H00142_A84EntidadDomicilioId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtEntidadDomicilioId_Internalname, GXutil.ltrim( GXutil.str( A84EntidadDomicilioId, 4, 0)));
            /* Execute user event: Load */
            e18142 ();
   ...
   public int subgrid1_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV10cEntidadDomicilioCPostal", AV10cEntidadDomicilioCPostal);
      /* Using cursor H00143 */
      pr_default.execute(1, new Object[] {new Integer(AV11pEntidadId), new Short(AV6cEntidadDomicilioId), new Integer(AV7cEntidadDomicilioNumero), new Short(AV8cEntidadDomicilioPiso), lV9cEntidadDomicilioDepto, lV10cEntidadDomicilioCPostal});
   ...
   {
      /* Enter Routine */
      AV12pEntidadDomicilioId = A84EntidadDomicilioId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12pEntidadDomicilioId", GXutil.ltrim( GXutil.str( AV12pEntidadDomicilioId, 4, 0)));
      httpContext.setWebReturnParms(new Object[] {new Short(AV12pEntidadDomicilioId)});
   ...
   {
      AV11pEntidadId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV11pEntidadId", GXutil.ltrim( GXutil.str( AV11pEntidadId, 6, 0)));
      AV12pEntidadDomicilioId = ((Number) GXutil.testNumericType( getParm(obj,1), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12pEntidadDomicilioId", GXutil.ltrim( GXutil.str( AV12pEntidadDomicilioId, 4, 0)));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20172191721349");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0171.js", "?20172191721350");
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cEntidadDomicilioId',fld:'vCENTIDADDOMICILIOID'},{av:'AV7cEntidadDomicilioNumero',fld:'vCENTIDADDOMICILIONUMERO'},{av:'AV8cEntidadDomicilioPiso',fld:'vCENTIDADDOMICILIOPISO'},{av:'AV9cEntidadDomicilioDepto',fld:'vCENTIDADDOMICILIODEPTO'},{av:'AV10cEntidadDomicilioCPostal',fld:'vCENTIDADDOMICILIOCPOSTAL'},{av:'AV11pEntidadId',fld:'vPENTIDADID',hsh:true}],oparms:[]}");
      setEventMetadata("'TOGGLE'","{handler:'e16141',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLENTIDADDOMICILIOIDFILTER.CLICK","{handler:'e11141',iparms:[{av:'divEntidaddomicilioidfiltercontainer_Class',ctrl:'ENTIDADDOMICILIOIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomicilioidfiltercontainer_Class',ctrl:'ENTIDADDOMICILIOIDFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomicilioid_Visible',ctrl:'vCENTIDADDOMICILIOID',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADDOMICILIONUMEROFILTER.CLICK","{handler:'e12141',iparms:[{av:'divEntidaddomicilionumerofiltercontainer_Class',ctrl:'ENTIDADDOMICILIONUMEROFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomicilionumerofiltercontainer_Class',ctrl:'ENTIDADDOMICILIONUMEROFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomicilionumero_Visible',ctrl:'vCENTIDADDOMICILIONUMERO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADDOMICILIOPISOFILTER.CLICK","{handler:'e13141',iparms:[{av:'divEntidaddomiciliopisofiltercontainer_Class',ctrl:'ENTIDADDOMICILIOPISOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomiciliopisofiltercontainer_Class',ctrl:'ENTIDADDOMICILIOPISOFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomiciliopiso_Visible',ctrl:'vCENTIDADDOMICILIOPISO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADDOMICILIODEPTOFILTER.CLICK","{handler:'e14141',iparms:[{av:'divEntidaddomiciliodeptofiltercontainer_Class',ctrl:'ENTIDADDOMICILIODEPTOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomiciliodeptofiltercontainer_Class',ctrl:'ENTIDADDOMICILIODEPTOFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomiciliodepto_Visible',ctrl:'vCENTIDADDOMICILIODEPTO',prop:'Visible'}]}");
      setEventMetadata("LBLENTIDADDOMICILIOCPOSTALFILTER.CLICK","{handler:'e15141',iparms:[{av:'divEntidaddomiciliocpostalfiltercontainer_Class',ctrl:'ENTIDADDOMICILIOCPOSTALFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divEntidaddomiciliocpostalfiltercontainer_Class',ctrl:'ENTIDADDOMICILIOCPOSTALFILTERCONTAINER',prop:'Class'},{av:'edtavCentidaddomiciliocpostal_Visible',ctrl:'vCENTIDADDOMICILIOCPOSTAL',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e19142',iparms:[{av:'A84EntidadDomicilioId',fld:'ENTIDADDOMICILIOID'}],oparms:[{av:'AV12pEntidadDomicilioId',fld:'vPENTIDADDOMICILIOID'}]}");
   ...
   public void initialize( )
   {
      ...
      H00142_A81EntidadId = new int[1] ;
      H00142_A89EntidadDomicilioCPostal = new String[] {""} ;
      H00142_A88EntidadDomicilioDepto = new String[] {""} ;
      H00142_A87EntidadDomicilioPiso = new short[1] ;
      H00142_A86EntidadDomicilioNumero = new int[1] ;
      H00142_A84EntidadDomicilioId = new short[1] ;
      H00143_AGRID1_nRecordCount = new long[1] ;
      AV13ADVANCED_LABEL_TEMPLATE = "" ;
      Grid1Row = new com.genexus.webpanels.GXWebRow();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kberp.gx0171__default(),
         new Object[] {
             new Object[] {
            H00142_A81EntidadId, H00142_A89EntidadDomicilioCPostal, H00142_A88EntidadDomicilioDepto, H00142_A87EntidadDomicilioPiso, H00142_A86EntidadDomicilioNumero, H00142_A84EntidadDomicilioId
            }
            , new Object[] {
   ...
   private short AV12pEntidadDomicilioId ;
   private short wbEnd ;
   ...
   private int wcpOAV11pEntidadId ;
   private int subGrid1_Rows ;
   private int AV7cEntidadDomicilioNumero ;
   private int AV11pEntidadId ;
   ...
   private int[] H00142_A81EntidadId ;
   private String[] H00142_A89EntidadDomicilioCPostal ;
   private String[] H00142_A88EntidadDomicilioDepto ;
   private short[] H00142_A87EntidadDomicilioPiso ;
   private int[] H00142_A86EntidadDomicilioNumero ;
   private short[] H00142_A84EntidadDomicilioId ;
   private long[] H00143_AGRID1_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class gx0171__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          int A81EntidadId )
   {
      ...
      String sFromString ;
      String sOrderString ;
      sSelectString = " EntidadId, EntidadDomicilioCPostal, EntidadDomicilioDepto, EntidadDomicilioPiso," ;
      sSelectString = sSelectString + " EntidadDomicilioNumero, EntidadDomicilioId" ;
      sFromString = " FROM EntidadDomicilio" ;
      sOrderString = "" ;
      sWhereString = sWhereString + " WHERE (EntidadId = ? and EntidadDomicilioId >= ?)" ;
      ...
      sOrderString = sOrderString + " ORDER BY EntidadId, EntidadDomicilioId" ;
                                          ...
                                          int A81EntidadId )
   {
      ...
      scmdbuf = scmdbuf + " WHERE (EntidadId = ? and EntidadDomicilioId >= ?)" ;
      if ( ! (0==AV7cEntidadDomicilioNumero) )
      {
         sWhereString = sWhereString + " and (EntidadDomicilioNumero >= ?)" ;
      }
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H00142(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).intValue() , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).intValue() , ((Number) dynConstraints[9]).shortValue() , ((Number) dynConstraints[10]).intValue() );
            case 1 :
                  return conditional_H00143(context, remoteHandle, httpContext, ((Number) dynConstraints[0]).intValue() , ((Number) dynConstraints[1]).shortValue() , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).intValue() , ((Number) dynConstraints[5]).shortValue() , (String)dynConstraints[6] , (String)dynConstraints[7] , ((Number) dynConstraints[8]).intValue() , ((Number) dynConstraints[9]).shortValue() , ((Number) dynConstraints[10]).intValue() );
      }
