/*
       ...
       Generated on: February 19, 2017 17:31:55.51
...
public final  class GxWebStd
{
                                           ...
                                           String sCallerPgm )
   {
      ...
      if ( ( httpContext.getWrapped( ) && ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) ) ) || ! httpContext.getWrapped( ) )
      {
         ...
         com.kberp.GxWebStd.classAttribute( httpContext, sClassString);
         if ( ! (GXutil.strcmp("", sAlign)==0) )
         {
            com.kberp.GxWebStd.styleAttribute( httpContext, sStyleString+"text-align:"+sAlign);
         }
         else
         {
            com.kberp.GxWebStd.styleAttribute( httpContext, sStyleString);
         }
         httpContext.writeText( sTags) ;
         httpContext.writeText( httpContext.htmlEndTag( HTMLElement.INPUT)) ;
         if ( nAutoComplete == 0 )
         {
            com.kberp.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "autocomplete", "off", false);
         }
      }
      if ( nEnabled == 0 )
      {
         ...
         if ( nFormat != 2 )
         {
            ...
            com.kberp.GxWebStd.classAttribute( httpContext, ClassHTML);
            com.kberp.GxWebStd.styleAttribute( httpContext, sOStyle);
            httpContext.writeText( ((GXutil.len( sTooltipText)>0) ? " title=\""+sTooltipText+"\"" : "")+" id=\"span_"+sCtrlName+"\""+" data-name=\"span_"+sCtrlName+"\""+" data-gx-enabled-id=\""+sCtrlName+"\"") ;
            httpContext.writeText( ">") ;
            ...
            com.kberp.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "");
         }
         if ( nIsPassword == 0 )
         {
            if ( nFormat == 0 )
         ...
         if ( nFormat != 2 )
         {
            com.kberp.GxWebStd.gx_end_js_anchor( httpContext, sEventJsCode, sUserOnClickCode, sLinkURL);
            httpContext.writeText( "</span>") ;
         }
      }
   }
                                     ...
                                     String sCallerPgm )
   {
      ...
      else
      {
         if ( nDisplay == 1 )
         {
            ...
            if ( GXutil.strcmp(sURL, "") != 0 )
            {
               com.kberp.GxWebStd.styleAttribute( httpContext, "display:block;"+sStyleString);
            }
            else
            {
               com.kberp.GxWebStd.styleAttribute( httpContext, "display:none;"+sStyleString);
            }
                                      ...
                                      String sCallerPgm )
   {
      ...
      if ( GXutil.strcmp(sBorderStyle, "rounded") == 0 )
      {
         ...
         httpContext.writeText( ")\" ") ;
         com.kberp.GxWebStd.styleAttribute( httpContext, sStyleString);
         com.kberp.GxWebStd.classAttribute( httpContext, sClassRoundedBtn);
      ...
      com.kberp.GxWebStd.gx_on_js_event( httpContext, "onclick", sEventJsCode);
      httpContext.writeText( " ") ;
      httpContext.writeText( sTags) ;
      httpContext.writeText( httpContext.htmlEndTag( HTMLElement.INPUT)) ;
      com.kberp.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "jsevent", sUserOnClickCode, false);
      if ( GXutil.strcmp(sBorderStyle, "rounded") == 0 )
      {
                                   ...
                                   String sInMaster )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         {
            httpContext.writeText( "<div") ;
            com.kberp.GxWebStd.classAttribute( httpContext, ((httpContext.GX_msglist.getItemType((short)(i))==1) ? "gx-error-message" : "gx-warning-message"));
            httpContext.writeText( ">") ;
                                         ...
                                         String sCallerPgm )
   {
      ...
      com.kberp.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "jsevent", sUserOnClickCode, false);
      com.kberp.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "gxoch0", sEventJsCode, true);
      if ( nEnabled == 0 )
      {
         if ( ( GXutil.len( sClassString) != 0 ) && ( GXutil.strSearch( sClassString, "Readonly", 1) != 1 ) )
         {
                                        ...
                                        String sTags )
   {
      ...
      httpContext.writeText( "<label for=\"") ;
      httpContext.writeValue( sCtrlName) ;
      httpContext.writeText( "\""+" class=\""+ClassHTML+"\" style=\""+GXutil.CssPrettify( sStyleString)+"\">") ;
      ...
      if ( (GXutil.strcmp("", sCaption)==0) )
      {
         httpContext.writeText( "<span style=\"display:none;\">"+sLabelCaption+"</span>") ;
      }
      else
      {
                                 ...
                                 String sCallerPgm )
   {
      ...
      {
         com.kberp.GxWebStd.gx_bitmap_readonly( httpContext, sInternalName, sImageURL, sLinkURL, sLinkTarget, sAccesskey, sThemeName, nVisible, nEnabled, sAlternateText, sTooltipText, nBorderWidth, nAutoresize, nWidth, nWidthUnit, nHeight, nHeightUnit, nVerticalSpace, nHorizontalSpace, nJScriptCode, sUserOnClickCode, sEventName, sStyleString, ClassHTML, sColumnClassString, sAlign, sImageTags, sUseMap, sJsDynCode, sCallerPgm, sImgSrcSet);
      }
      else
      {
         com.kberp.GxWebStd.gx_multimedia_upload_start( httpContext, sInternalName, nVisible, nWidth, sStyleString);
         ...
         httpContext.writeText( "</span>") ;
         httpContext.writeText( "</a>") ;
         com.kberp.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sImageURL, sTooltipText, nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", sAlign, sInputTags, nReadOnly, bIsBlob, "image/*", sCallerPgm);
      }
   }
                                          ...
                                          String sImgSrcSet )
   {
      ...
      {
         com.kberp.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "gx-image-link");
      }
      if ( ! (GXutil.strcmp("", sImageURL)==0) )
      {
                                                ...
                                                String sCallerPgm )
   {
      ...
      com.kberp.GxWebStd.gx_single_line_edit( httpContext, sInternalName+"_GXI", sURL, sURL, sInputTags, sEventName, "", "", sTooltipText, "", sUserOnClickCode, 0, "field "+sClassString, sStyleString, "", "", 1, 1, 1, "text", "", nWidth, nWidthUnit, nHeight, nHeightUnit, 254, (byte)(0), (short)(2), 0, (byte)(1), (byte)(1), (byte)(0), true, "", sAlign, sCallerPgm);
                                ...
                                String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.kberp.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", sInputTags, nReadOnly, bIsBlob, "video/*", sCallerPgm);
      }
   }
                                ...
                                String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.kberp.GxWebStd.gx_multimedia_upload_end( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", sInputTags, nReadOnly, bIsBlob, "audio/*", sCallerPgm);
      }
   }
                                     ...
                                     String sCallerPgm )
   {
      ...
      if ( nFormat == 1 )
      {
         ...
         httpContext.writeText( "<div") ;
         com.kberp.GxWebStd.classAttribute( httpContext, sClassString);
         com.kberp.GxWebStd.styleAttribute( httpContext, sStyle);
      ...
      {
         com.kberp.GxWebStd.gx_ctrl_attribute( httpContext, sInternalName, "data-gxformat", GXutil.str( nFormat, 1, 0), false);
      }
      if ( ( nFormat == 1 ) && ( ! (GXutil.strcmp("", sEventJsCode)==0) || ! (GXutil.strcmp("", sUserOnClickCode)==0) || ! (GXutil.strcmp("", sLinkURL)==0) ) )
      {
         com.kberp.GxWebStd.gx_ctrl_attribute( httpContext, sInternalName, "gxlink", "1", false);
      }
   }
                                          ...
                                          String sClassString )
   {
      ...
      else
      {
         ...
         {
            com.kberp.GxWebStd.gx_link_start( httpContext, sLinkURL, sLinkTarget, sClassString);
         }
      }
   }
                                        ...
                                        String sLinkURL )
   {
      ...
      {
         com.kberp.GxWebStd.gx_link_end( httpContext, sLinkURL);
      }
   }
   ...
   {
      httpContext.writeText( "<label class=\"gx-label ") ;
                                       ...
                                       boolean bIsRwd )
   {
      ...
      com.kberp.GxWebStd.set_html_headers( httpContext, nContentType, sCacheCtrl, sCacheExp);
      httpContext.setStream();
      if ( nContentType == 0 )
      {
                                        ...
                                        String sCallerPgm )
   {
      ...
      com.kberp.GxWebStd.classAttribute( httpContext, sClassString);
      com.kberp.GxWebStd.styleAttribute( httpContext, sTextAreaStyleString);
      ...
      httpContext.writeTextNL( ">") ;
      httpContext.writeValue( GXutil.trim( sValue)) ;
      httpContext.writeTextNL( "</textarea>") ;
      com.kberp.GxWebStd.gx_ctrl_attribute( httpContext, sCtrlName, "maxlength", sLength, false);
      if ( nEnabled == 0 )
      {
         ...
         com.kberp.GxWebStd.gx_start_js_anchor( httpContext, nJScriptCode, sEventJsCode, "", sLinkURL, sLinkTarget, "");
         if ( nFormat == 0 )
         {
         ...
         com.kberp.GxWebStd.gx_end_js_anchor( httpContext, sEventJsCode, "", sLinkURL);
         httpContext.writeText( "</span>") ;
      }
   }
                                      ...
                                      String sCallerPgm )
   {
      ...
      com.kberp.GxWebStd.classAttribute( httpContext, sClassString+"Title");
      httpContext.writeText( ">") ;
      httpContext.writeText( sCaption) ;
      httpContext.writeText( "</legend>") ;
   }
                                               ...
                                               String sCallerPgm )
   {
      ...
      if ( ( httpContext.getWrapped( ) && ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) ) ) || ! httpContext.getWrapped( ) )
      {
         ...
         if ( nAutoComplete == 0 )
         {
            com.kberp.GxWebStd.gx_ctrl_attribute_wml( httpContext, sCtrlName, "autocomplete", "off", false);
         }
      }
      if ( nEnabled == 0 )
      {
         ...
         if ( nFormat != 2 )
         {
            ...
            com.kberp.GxWebStd.gx_start_js_anchor_wml( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "");
         }
         if ( nIsPassword == 0 )
         {
            if ( nFormat == 0 )
         ...
         if ( nFormat != 2 )
         {
            com.kberp.GxWebStd.gx_end_js_anchor_wml( httpContext, sEventJsCode, sUserOnClickCode, sLinkURL);
         }
      }
   }
                                          ...
                                          String sCallerPgm )
   {
      ...
      sEventJsCode = sJsCode + sEventJsCode ;
      com.kberp.GxWebStd.gx_on_js_event_wml( httpContext, "onclick", sEventJsCode);
      httpContext.writeText( " ") ;
      httpContext.writeText( sTags) ;
      httpContext.writeText( httpContext.htmlEndTag( HTMLElement.INPUT)) ;
      com.kberp.GxWebStd.gx_ctrl_attribute_wml( httpContext, sCtrlName, "jsevent", sUserOnClickCode, false);
      if ( GXutil.strcmp(sBorderStyle, "rounded") == 0 )
      {
         httpContext.writeText( "</span></span></span></span>") ;
      }
                                             ...
                                             String sCallerPgm )
   {
      ...
      httpContext.writeTextNL( "</select>") ;
      com.kberp.GxWebStd.gx_ctrl_attribute_wml( httpContext, sCtrlName, "jsevent", sUserOnClickCode, false);
      com.kberp.GxWebStd.gx_ctrl_attribute_wml( httpContext, sCtrlName, "gxoch0", sEventJsCode, true);
      if ( nEnabled == 0 )
      {
         if ( ( GXutil.len( sClassString) != 0 ) && ( GXutil.strSearch( sClassString, "Readonly", 1) != 1 ) )
         {
                                     ...
                                     String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 1 ) || ( nEnabled == 0 ) )
      {
         com.kberp.GxWebStd.gx_bitmap_readonly_wml( httpContext, sInternalName, sImageURL, sLinkURL, sLinkTarget, sAccesskey, sThemeName, nVisible, nEnabled, sAlternateText, sTooltipText, nBorderWidth, nAutoresize, nWidth, nWidthUnit, nHeight, nHeightUnit, nVerticalSpace, nHorizontalSpace, nJScriptCode, sUserOnClickCode, sEventName, sStyleString, ClassHTML, sColumnClassString, sAlign, sImageTags, sUseMap, sJsDynCode, sCallerPgm, sImgSrcSet);
      }
      else
      {
         com.kberp.GxWebStd.gx_multimedia_upload_start_wml( httpContext, sInternalName, nVisible, nWidth, sStyleString);
         httpContext.writeText( "<a class=\"action change-action\" gxfocusable=\"1\" href=\"\"") ;
         httpContext.writeText( sInputTags) ;
         httpContext.writeText( ">") ;
         httpContext.writeText( httpContext.getMessage( "GXM_multimediachange", "")) ;
         ...
         httpContext.writeText( "</span>") ;
         httpContext.writeText( "</a>") ;
         com.kberp.GxWebStd.gx_multimedia_upload_end_wml( httpContext, sInternalName, sImageURL, sTooltipText, nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", sAlign, sInputTags, nReadOnly, bIsBlob, "image/*", sCallerPgm);
      }
   }
                                              ...
                                              String sImgSrcSet )
   {
      ...
      if ( ( nEnabled != 0 ) && ( GXutil.strcmp(sLinkURL, "") != 0 ) )
      {
         com.kberp.GxWebStd.gx_start_js_anchor_wml( httpContext, nJScriptCode, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget, "gx-image-link");
      }
      if ( ! (GXutil.strcmp("", sImageURL)==0) )
      {
         httpContext.writeText( "<img src=\""+httpContext.convertURL( sImageURL)+"\"") ;
                                                    ...
                                                    String sCallerPgm )
   {
      ...
      com.kberp.GxWebStd.gx_single_line_edit_wml( httpContext, sInternalName+"_GXI", sURL, sURL, sInputTags, sEventName, "", "", sTooltipText, "", sUserOnClickCode, 0, "field "+sClassString, sStyleString, "", "", 1, 1, 1, "text", "", nWidth, nWidthUnit, nHeight, nHeightUnit, 254, (byte)(0), (short)(2), 0, (byte)(1), (byte)(1), (byte)(0), true, "", sAlign, sCallerPgm);
      httpContext.writeText( "<input type=\"file\" class=\"field ") ;
      httpContext.writeValue( sClassString) ;
      httpContext.writeText( "\"") ;
      httpContext.writeText( " id=\"") ;
                                    ...
                                    String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.kberp.GxWebStd.gx_multimedia_upload_end_wml( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", sInputTags, nReadOnly, bIsBlob, "video/*", sCallerPgm);
      }
   }
                                    ...
                                    String sCallerPgm )
   {
      ...
      if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
      {
         com.kberp.GxWebStd.gx_multimedia_upload_end_wml( httpContext, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", sInputTags, nReadOnly, bIsBlob, "audio/*", sCallerPgm);
      }
   }
                                         ...
                                         String sCallerPgm )
   {
      ...
      if ( ( nFormat != 0 ) && ( nFormat != 2 ) )
      {
         com.kberp.GxWebStd.gx_ctrl_attribute_wml( httpContext, sInternalName, "data-gxformat", GXutil.str( nFormat, 1, 0), false);
      }
      if ( ( nFormat == 1 ) && ( ! (GXutil.strcmp("", sEventJsCode)==0) || ! (GXutil.strcmp("", sUserOnClickCode)==0) || ! (GXutil.strcmp("", sLinkURL)==0) ) )
      {
         com.kberp.GxWebStd.gx_ctrl_attribute_wml( httpContext, sInternalName, "gxlink", "1", false);
      }
   }
                                              ...
                                              String sClassString )
   {
      ...
      else
      {
         ...
         {
            com.kberp.GxWebStd.gx_link_start_wml( httpContext, sLinkURL, sLinkTarget, sClassString);
         }
      }
   }
                                            ...
                                            String sLinkURL )
   {
      ...
      {
         com.kberp.GxWebStd.gx_link_end_wml( httpContext, sLinkURL);
      }
   }

   public static void gx_label_element_wml( HttpContext httpContext ,
                                            String sReferencedControl ,
                                            String sLabelCaption ,
                                            String sLabelClass ,
                                            int nLabelPosition ,
                                           ...
                                           boolean bIsRwd )
   {
      ...
      byte idxLst ;
      boolean addContentType ;
      com.kberp.GxWebStd.set_html_headers_wml( httpContext, nContentType, sCacheCtrl, sCacheExp);
      httpContext.setStream();
      if ( nContentType == 0 )
      {
         httpContext.writeTextNL( httpContext.htmlDocType( )) ;
                                            ...
                                            String sCallerPgm )
   {
      ...
      httpContext.writeValue( GXutil.trim( sValue)) ;
      httpContext.writeTextNL( "</textarea>") ;
      com.kberp.GxWebStd.gx_ctrl_attribute_wml( httpContext, sCtrlName, "maxlength", sLength, false);
      if ( nEnabled == 0 )
      {
         /* Initialize internal JScript code according to EventNo */
         if ( nJScriptCode == 1 )
         ...
         com.kberp.GxWebStd.gx_start_js_anchor_wml( httpContext, nJScriptCode, sEventJsCode, "", sLinkURL, sLinkTarget, "");
         if ( nFormat == 0 )
         {
            httpContext.writeValueEnter( sValue) ;
         }
         ...
         com.kberp.GxWebStd.gx_end_js_anchor_wml( httpContext, sEventJsCode, "", sLinkURL);
      }
   }
   ...
   public static void gx_geolocation_wml( HttpContext httpContext ,
                                          ...
                                          String sAlign )
   {
      com.kberp.GxWebStd.gx_single_line_edit_wml( httpContext, sCtrlName, sValue, sFormatedValue, sTags, sEventName, sLinkURL, sLinkTarget, sTooltipText, sPlaceholder, sUserOnClickCode, nJScriptCode, sClassString, sStyleString, sROClassString, sColumnClassString, nVisible, nEnabled, nRTEnabled, sType, sStep, nWidth, nWidthUnit, nHeight, nHeightUnit, nLength, nIsPassword, nFormat, nParentId, bHasTheme, nAutoComplete, nAutoCorrection, bSendHidden, sDomainType, "", "");
      if ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) )
      {
         com.kberp.GxWebStd.gx_bitmap_readonly_wml( httpContext, sCtrlName+"_geoLocMe", httpContext.convertURL( "locateMe"), "", "", "", "", nVisible, 1, httpContext.getMessage( "GXM_locatemeoption", ""), httpContext.getMessage( "GXM_locatemeoption", ""), 0, 0, 0, nWidthUnit, 0, nHeightUnit, 0, 0, 4, sUserOnClickCode, sEventName, sStyleString, "GeoLocOption", "", "", "", "", "gx.geolocation.getMyPosition(this);", "", "");
      }
   }
   ...
   public static void gx_div_end_wml( HttpContext httpContext ,
                                      String sAlign ,
                                      String sVAlign ,
                                      String sHtmlTag )
   {
