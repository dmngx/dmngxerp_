/*
       ...
       Generated on: February 19, 2017 17:32:14.13
...
public final  class rwdpromptmasterpage_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm062( )
   {
      ...
      httpContext.AddJavascriptSource("rwdpromptmasterpage.js", "?201721917321414");
   ...
   public void wb060( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", "PromptMainTable", "left", "top", "", "", "div");
         /* Div Control */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?201721917321422");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("rwdpromptmasterpage.js", "?201721917321422");
      }
