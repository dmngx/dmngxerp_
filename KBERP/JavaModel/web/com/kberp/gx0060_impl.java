...
public final  class gx0060_impl extends GXDataArea
{
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         else if ( GXutil.strcmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
         {
            ...
            AV6cRubroId = (short)(GXutil.lval( httpContext.GetNextPar( ))) ;
            httpContext.setAjaxCallMode();
            if ( ! httpContext.IsValidAjaxCall( true) )
            {
               GxWebError = (byte)(1) ;
            ...
            gxgrgrid1_refresh( subGrid1_Rows, AV6cRubroId) ;
         ...
         {
            AV7pRubroId = (short)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV7pRubroId", GXutil.ltrim( GXutil.str( AV7pRubroId, 4, 0)));
         }
         if ( httpContext.isSpaRequest( ) )
         {
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201721917321715");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kberp.gx0060") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7pRubroId,4,0)))+"\">") ;
   ...
   public void renderHtmlCloseForm( )
   {
      ...
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "GXH_vCRUBROID", GXutil.ltrim( localUtil.ntoc( AV6cRubroId, (byte)(4), (byte)(0), ",", "")));
      /* Send saved values. */
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_24", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_24, (byte)(4), (byte)(0), ",", "")));
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "vPRUBROID", GXutil.ltrim( localUtil.ntoc( AV7pRubroId, (byte)(4), (byte)(0), ",", "")));
   ...
   {
      return formatLink("com.kberp.gx0060") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV7pRubroId,4,0))) ;
   }
   ...
   public void wb0C0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblLblrubroidfilter_Internalname, "Rubro Id", "", "", lblLblrubroidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110c1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0060.htm");
         ...
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtavCrubroid_Internalname, GXutil.ltrim( localUtil.ntoc( AV6cRubroId, (byte)(4), (byte)(0), ",", "")), ((edtavCrubroid_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV6cRubroId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV6cRubroId), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCrubroid_Jsonclick, 0, "Attribute", "", "", "", edtavCrubroid_Visible, edtavCrubroid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx0060.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e120c1_client"+"'", TempTags, "", 2, "HLP_Gx0060.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 24 )
      {
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 24, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0060.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void start0C2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "Selection List Rubro", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
                           ...
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( GXutil.strcmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( localUtil.ctol( httpContext.cgiGet( "GXH_vCRUBROID"), ",", ".") != AV6cRubroId )
                                    {
                                       Rfr0gs = true ;
                                    }
                                    if ( ! Rfr0gs )
   ...
   public void rf0C2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000C2 */
         pr_default.execute(0, new Object[] {new Short(AV6cRubroId), new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_24_idx = (short)(1) ;
         sGXsfl_24_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_24_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_242( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subgrid1_recordsperpage( ) ) ) ) )
         {
            A11RubroId = H000C2_A11RubroId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, edtRubroId_Internalname, GXutil.ltrim( GXutil.str( A11RubroId, 4, 0)));
            /* Execute user event: Load */
            e140C2 ();
   ...
   {
      /* Using cursor H000C3 */
      pr_default.execute(1, new Object[] {new Short(AV6cRubroId)});
   ...
   public void strup0C0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         if ( ( ( localUtil.ctol( httpContext.cgiGet( edtavCrubroid_Internalname), ",", ".") < 0 ) ) || ( ( localUtil.ctol( httpContext.cgiGet( edtavCrubroid_Internalname), ",", ".") > 9999 ) ) )
         {
            ...
            wbErr = true ;
            AV6cRubroId = (short)(0) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cRubroId", GXutil.ltrim( GXutil.str( AV6cRubroId, 4, 0)));
         }
         else
         {
            AV6cRubroId = (short)(localUtil.ctol( httpContext.cgiGet( edtavCrubroid_Internalname), ",", ".")) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV6cRubroId", GXutil.ltrim( GXutil.str( AV6cRubroId, 4, 0)));
         }
         /* Read saved values. */
   ...
   {
      /* Start Routine */
      Form.setCaption( GXutil.format( "Lista de Selección %1", "Rubro", "", "", "", "", "", "", "", "") );
   ...
   {
      /* Enter Routine */
      AV7pRubroId = A11RubroId ;
      httpContext.ajax_rsp_assign_attri("", false, "AV7pRubroId", GXutil.ltrim( GXutil.str( AV7pRubroId, 4, 0)));
      httpContext.setWebReturnParms(new Object[] {new Short(AV7pRubroId)});
   ...
   {
      AV7pRubroId = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.SHORT)).shortValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV7pRubroId", GXutil.ltrim( GXutil.str( AV7pRubroId, 4, 0)));
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201721917321786");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0060.js", "?201721917321786");
   ...
   public void sendrow_242( )
   {
      ...
      if ( ( 10 * 1 == 0 ) || ( nGXsfl_24_idx <= subgrid1_recordsperpage( ) * 1 ) )
      {
         ...
         edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+PrivateUtilities.encodeJSConstant( GXutil.ltrim( localUtil.ntoc( A11RubroId, (byte)(4), (byte)(0), ",", "")))+"'"+"]);" ;
         ...
         Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtRubroId_Internalname,GXutil.ltrim( localUtil.ntoc( A11RubroId, (byte)(4), (byte)(0), ",", "")),localUtil.format( DecimalUtil.doubleToDec(A11RubroId), "ZZZ9"),"","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtRubroId_Jsonclick,new Integer(0),"Attribute","",ROClassString,"WWColumn",new Integer(-1),new Integer(0),new Integer(0),"text","",new Integer(0),"px",new Integer(17),"px",new Integer(4),new Integer(0),new Integer(0),new Integer(24),new Integer(1),new Integer(-1),new Integer(0),new Boolean(true),"IdTablasGenerales","right"});
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "Selection List Rubro" );
      subGrid1_Rows = 10 ;
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cRubroId',fld:'vCRUBROID'}],oparms:[]}");
      setEventMetadata("'TOGGLE'","{handler:'e120C1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLRUBROIDFILTER.CLICK","{handler:'e110C1',iparms:[{av:'divRubroidfiltercontainer_Class',ctrl:'RUBROIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divRubroidfiltercontainer_Class',ctrl:'RUBROIDFILTERCONTAINER',prop:'Class'},{av:'edtavCrubroid_Visible',ctrl:'vCRUBROID',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e150C2',iparms:[{av:'A11RubroId',fld:'RUBROID'}],oparms:[{av:'AV7pRubroId',fld:'vPRUBROID'}]}");
      setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cRubroId',fld:'vCRUBROID'}],oparms:[]}");
      setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cRubroId',fld:'vCRUBROID'}],oparms:[]}");
      setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cRubroId',fld:'vCRUBROID'}],oparms:[]}");
      setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows'},{av:'AV6cRubroId',fld:'vCRUBROID'}],oparms:[]}");
   }
   ...
   public void initialize( )
   {
      ...
      scmdbuf = "" ;
      H000C2_A11RubroId = new short[1] ;
      H000C3_AGRID1_nRecordCount = new long[1] ;
      AV8ADVANCED_LABEL_TEMPLATE = "" ;
      Grid1Row = new com.genexus.webpanels.GXWebRow();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kberp.gx0060__default(),
         new Object[] {
             new Object[] {
            H000C2_A11RubroId
            }
   ...
   private short AV6cRubroId ;
   private short AV7pRubroId ;
   private short wbEnd ;
   ...
   private short[] H000C2_A11RubroId ;
...
final  class gx0060__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("H000C2", "SELECT RubroId FROM Rubro WHERE RubroId >= ? ORDER BY RubroId  OFFSET ? LIMIT CASE WHEN ? > 0 THEN ? ELSE 1e9 END",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,11,0,false )
         ,new ForEachCursor("H000C3", "SELECT COUNT(*) FROM Rubro WHERE RubroId >= ? ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,false )
      };
   }
