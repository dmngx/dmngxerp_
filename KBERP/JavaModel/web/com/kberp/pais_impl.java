/*
       ...
       Generated on: February 19, 2017 17:31:57.14
...
public final  class pais_impl extends GXDataArea
{
   ...
   public void draw( )
   {
      ...
      if ( ! com.kberp.GxWebStd.gx_redirect( httpContext) )
      {
         ...
         /* Text block */
         com.kberp.GxWebStd.gx_label_ctrl( httpContext, lblTitle_Internalname, "Pais", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, (short)(0), "HLP_Pais.htm");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_first_Internalname, "", "", bttBtn_first_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_first_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EFIRST."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_previous_Internalname, "", "", bttBtn_previous_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_previous_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EPREVIOUS."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         ClassString = "BtnNext" ;
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_next_Internalname, "", "", bttBtn_next_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_next_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ENEXT."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         ClassString = "BtnLast" ;
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_last_Internalname, "", "", bttBtn_last_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_last_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ELAST."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_select_Internalname, "", "Seleccionar", bttBtn_select_Jsonclick, 4, "Seleccionar", "", StyleString, ClassString, bttBtn_select_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ESELECT."+"'", TempTags, "gx.popup.openPrompt('"+"com.kberp.gx0020"+"',["+"{Ctrl:gx.dom.el('"+"PAISID"+"'), id:'"+"PAISID"+"'"+",IOType:'out',isKey:true,isLastKey:true}"+"],"+"null"+","+"'', false"+","+"true"+");"+"return false;", 2, "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.kberp.GxWebStd.gx_label_element( httpContext, edtPaisId_Internalname, "Id", "col-sm-3 AttributeLabel", 1, true);
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 33,'',false,'',0)\"" ;
         com.kberp.GxWebStd.gx_single_line_edit( httpContext, edtPaisId_Internalname, GXutil.ltrim( localUtil.ntoc( A3PaisId, (byte)(4), (byte)(0), ",", "")), ((edtPaisId_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A3PaisId), "ZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A3PaisId), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,33);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisId_Jsonclick, 0, "Attribute", "", "", "", 1, edtPaisId_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "IdTablasGenerales", "right", "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Attribute/Variable Label */
         com.kberp.GxWebStd.gx_label_element( httpContext, edtPaisNombre_Internalname, "Nombre", "col-sm-3 AttributeLabel", 1, true);
         /* Multiple line edit */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         com.kberp.GxWebStd.gx_html_textarea( httpContext, edtPaisNombre_Internalname, A4PaisNombre, "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,37);\"", (short)(0), 1, edtPaisNombre_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "250", -1, 0, "", "", (byte)(-1), true, "NombreTablasGenerales", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_enter_Internalname, "", "Confirmar", bttBtn_enter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, bttBtn_enter_Visible, bttBtn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.kberp.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.kberp.GxWebStd.gx_button_ctrl( httpContext, bttBtn_delete_Internalname, "", "Eliminar", bttBtn_delete_Jsonclick, 5, "Eliminar", "", StyleString, ClassString, bttBtn_delete_Visible, bttBtn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Pais.htm");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.kberp.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void standaloneStartupServer( )
   {
      ...
      if ( AnyError == 0 )
      {
         if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
         {
            ...
            A4PaisNombre = httpContext.cgiGet( edtPaisNombre_Internalname) ;
            httpContext.ajax_rsp_assign_attri("", false, "A4PaisNombre", A4PaisNombre);
            /* Read saved values. */
            Z3PaisId = (short)(localUtil.ctol( httpContext.cgiGet( "Z3PaisId"), ",", ".")) ;
            Z4PaisNombre = httpContext.cgiGet( "Z4PaisNombre") ;
   ...
   public void zm022( int GX_JID )
   {
      if ( ( GX_JID == 1 ) || ( GX_JID == 0 ) )
      {
         if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
         {
            Z4PaisNombre = T00023_A4PaisNombre[0] ;
         }
         else
         {
            Z4PaisNombre = A4PaisNombre ;
         }
      }
      if ( GX_JID == -1 )
      {
   ...
   {
      /* Using cursor T00024 */
      pr_default.execute(2, new Object[] {new Short(A3PaisId)});
      if ( (pr_default.getStatus(2) != 101) )
      {
         RcdFound2 = (short)(1) ;
         A4PaisNombre = T00024_A4PaisNombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A4PaisNombre", A4PaisNombre);
         zm022( -1) ;
      }
      pr_default.close(2);
   ...
   {
      /* Using cursor T00023 */
      pr_default.execute(1, new Object[] {new Short(A3PaisId)});
      if ( (pr_default.getStatus(1) != 101) )
      {
         zm022( 1) ;
         RcdFound2 = (short)(1) ;
         A3PaisId = T00023_A3PaisId[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A3PaisId", GXutil.ltrim( GXutil.str( A3PaisId, 4, 0)));
         A4PaisNombre = T00023_A4PaisNombre[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A4PaisNombre", A4PaisNombre);
         Z3PaisId = A3PaisId ;
         sMode2 = Gx_mode ;
         Gx_mode = "DSP" ;
   ...
   public void move_next( )
   {
      RcdFound2 = (short)(0) ;
      /* Using cursor T00026 */
      pr_default.execute(4, new Object[] {new Short(A3PaisId)});
      if ( (pr_default.getStatus(4) != 101) )
      {
         while ( (pr_default.getStatus(4) != 101) && ( ( T00026_A3PaisId[0] < A3PaisId ) ) )
         {
            pr_default.readNext(4);
         }
         if ( (pr_default.getStatus(4) != 101) && ( ( T00026_A3PaisId[0] > A3PaisId ) ) )
         {
            A3PaisId = T00026_A3PaisId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A3PaisId", GXutil.ltrim( GXutil.str( A3PaisId, 4, 0)));
            RcdFound2 = (short)(1) ;
         }
      }
   ...
   public void move_previous( )
   {
      RcdFound2 = (short)(0) ;
      /* Using cursor T00027 */
      pr_default.execute(5, new Object[] {new Short(A3PaisId)});
      if ( (pr_default.getStatus(5) != 101) )
      {
         while ( (pr_default.getStatus(5) != 101) && ( ( T00027_A3PaisId[0] > A3PaisId ) ) )
         {
            pr_default.readNext(5);
         }
         if ( (pr_default.getStatus(5) != 101) && ( ( T00027_A3PaisId[0] < A3PaisId ) ) )
         {
   ...
   public void btn_get( )
   {
      ...
      if ( RcdFound2 == 0 )
      {
         httpContext.GX_msglist.addItem(localUtil.getMessages().getMessage("GXM_keynfound"), "PrimaryKeyNotFound", 1, "PAISID");
         AnyError = (short)(1) ;
         GX_FocusControl = edtPaisId_Internalname ;
         httpContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
      }
   ...
   public void checkOptimisticConcurrency022( )
   {
      ...
      {
         /* Using cursor T00022 */
         pr_default.execute(0, new Object[] {new Short(A3PaisId)});
         ...
         if ( (pr_default.getStatus(0) == 101) || ( GXutil.strcmp(Z4PaisNombre, T00022_A4PaisNombre[0]) != 0 ) )
         {
      ...
      if ( AnyError == 0 )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               {
                  /* Using cursor T00028 */
                  pr_default.execute(6, new Object[] {new Short(A3PaisId), A4PaisNombre});
      ...
      if ( AnyError == 0 )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               {
                  /* Using cursor T00029 */
                  pr_default.execute(7, new Object[] {A4PaisNombre, new Short(A3PaisId)});
                  Application.getSmartCacheProvider(remoteHandle).setUpdated("Pais") ;
   ...
   public void onDeleteControls022( )
   {
      ...
      if ( AnyError == 0 )
      {
         ...
         pr_default.execute(9, new Object[] {new Short(A3PaisId)});
         ...
         pr_default.execute(10, new Object[] {new Short(A3PaisId)});
   ...
   public void endLevel022( )
   {
      ...
      if ( AnyError == 0 )
      {
         Application.commit(context, remoteHandle, "DEFAULT",pr_default, "pais");
         if ( AnyError == 0 )
         {
            confirmValues020( ) ;
         }
      ...
      {
         Application.rollback(context, remoteHandle, "DEFAULT",pr_default, "pais");
      }
      IsModified = (short)(0) ;
      if ( AnyError != 0 )
      {
   ...
   public void disableAttributes022( )
   {
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtPaisNombre_Internalname, "Enabled", GXutil.ltrim( GXutil.str( edtPaisNombre_Enabled, 5, 0)));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201721917315850");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.kberp.pais") +"\">") ;
   ...
   public void renderHtmlCloseForm( )
   {
      ...
      com.kberp.GxWebStd.gx_hidden_field( httpContext, "Z4PaisNombre", Z4PaisNombre);
   ...
   {
      return formatLink("com.kberp.pais")  ;
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201721917315856");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("pais.js", "?201721917315857");
   ...
   public void initialize( )
   {
      ...
      EvtRowId = "" ;
      sEvtType = "" ;
      T00024_A3PaisId = new short[1] ;
      T00024_A4PaisNombre = new String[] {""} ;
      T00025_A3PaisId = new short[1] ;
      T00023_A3PaisId = new short[1] ;
      T00023_A4PaisNombre = new String[] {""} ;
      sMode2 = "" ;
      T00026_A3PaisId = new short[1] ;
      T00027_A3PaisId = new short[1] ;
      T00022_A3PaisId = new short[1] ;
      T00022_A4PaisNombre = new String[] {""} ;
      T000211_A42EmpresaId = new int[1] ;
      T000211_A81EntidadId = new int[1] ;
      T000212_A42EmpresaId = new int[1] ;
      T000213_A3PaisId = new short[1] ;
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      isValidOutput = new com.genexus.GxUnknownObjectCollection();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kberp.pais__default(),
         new Object[] {
             new Object[] {
            T00022_A3PaisId, T00022_A4PaisNombre
            }
            , new Object[] {
            T00023_A3PaisId, T00023_A4PaisNombre
            }
            , new Object[] {
            T00024_A3PaisId, T00024_A4PaisNombre
            }
            , new Object[] {
            T00025_A3PaisId
            }
            ...
            , new Object[] {
            T000211_A42EmpresaId, T000211_A81EntidadId
            }
            , new Object[] {
            T000212_A42EmpresaId
            }
            , new Object[] {
            T000213_A3PaisId
            }
   ...
   private String Z4PaisNombre ;
   private String A4PaisNombre ;
   private com.genexus.GxUnknownObjectCollection isValidOutput ;
   private IDataStoreProvider pr_default ;
   private short[] T00024_A3PaisId ;
   private String[] T00024_A4PaisNombre ;
   private short[] T00025_A3PaisId ;
   private short[] T00023_A3PaisId ;
   private String[] T00023_A4PaisNombre ;
   private short[] T00026_A3PaisId ;
   private short[] T00027_A3PaisId ;
   private short[] T00022_A3PaisId ;
   private String[] T00022_A4PaisNombre ;
   private int[] T000211_A42EmpresaId ;
   private int[] T000211_A81EntidadId ;
   private int[] T000212_A42EmpresaId ;
   private short[] T000213_A3PaisId ;
...
final  class pais__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   ...
   {
      return new Cursor[] {
          new ForEachCursor("T00022", "SELECT PaisId, PaisNombre FROM Pais WHERE PaisId = ?  FOR UPDATE OF Pais NOWAIT",true, GX_NOMASK, false, this,1,0,false )
         ,new ForEachCursor("T00023", "SELECT PaisId, PaisNombre FROM Pais WHERE PaisId = ? ",true, GX_NOMASK, false, this,1,0,false )
         ,new ForEachCursor("T00024", "SELECT TM1.PaisId, TM1.PaisNombre FROM Pais TM1 WHERE TM1.PaisId = ? ORDER BY TM1.PaisId ",true, GX_NOMASK, false, this,100,0,false )
         ,new ForEachCursor("T00025", "SELECT PaisId FROM Pais WHERE PaisId = ? ",true, GX_NOMASK, false, this,1,0,false )
         ,new ForEachCursor("T00026", "SELECT PaisId FROM Pais WHERE ( PaisId > ?) ORDER BY PaisId  LIMIT 1",true, GX_NOMASK, false, this,1,0,true )
         ,new ForEachCursor("T00027", "SELECT PaisId FROM Pais WHERE ( PaisId < ?) ORDER BY PaisId DESC  LIMIT 1",true, GX_NOMASK, false, this,1,0,true )
         ,new UpdateCursor("T00028", "SAVEPOINT gxupdate;INSERT INTO Pais(PaisId, PaisNombre) VALUES(?, ?);RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new UpdateCursor("T00029", "SAVEPOINT gxupdate;UPDATE Pais SET PaisNombre=?  WHERE PaisId = ?;RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new UpdateCursor("T000210", "SAVEPOINT gxupdate;DELETE FROM Pais  WHERE PaisId = ?;RELEASE SAVEPOINT gxupdate", GX_ROLLBACKSAVEPOINT + GX_NOMASK)
         ,new ForEachCursor("T000211", "SELECT EmpresaId, EntidadId FROM Entidad WHERE EntidadPaisId = ?  LIMIT 1",true, GX_NOMASK, false, this,1,0,true )
         ,new ForEachCursor("T000212", "SELECT EmpresaId FROM Empresa WHERE PaisId = ?  LIMIT 1",true, GX_NOMASK, false, this,1,0,true )
         ,new ForEachCursor("T000213", "SELECT PaisId FROM Pais ORDER BY PaisId ",true, GX_NOMASK, false, this,100,0,false )
      };
   }
