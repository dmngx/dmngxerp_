/*!   GeneXus Java 15_0_2-109402 on February 19, 2017 17:32:0.89
*/
gx.evt.autoSkip = false;
gx.define('localidad', false, function () {
   this.ServerClass =  "localidad" ;
   ...
   {
      gx.ajax.validSrvEvt("dyncall","valid_Localidadid",["gx.O.A5LocalidadId", "gx.O.A6LocalidadNombre"],["A6LocalidadNombre", "Gx_mode", "Z5LocalidadId", "Z6LocalidadNombre", ["BTN_DELETE","Enabled"], ["BTN_ENTER","Enabled"]]);
      return true;
   }
   ...
   GXValidFnc[33]={lvl:0,type:"int",len:4,dec:0,sign:false,pic:"ZZZ9",ro:0,grid:0,gxgrid:null,fnc:this.Valid_Localidadid,isvalid:null,rgrid:[],fld:"LOCALIDADID",gxz:"Z5LocalidadId",gxold:"O5LocalidadId",gxvar:"A5LocalidadId",ucs:[],op:[37],ip:[37,33],nacdep:[],ctrltype:"edit",v2v:function(Value){gx.O.A5LocalidadId=gx.num.intval(Value)},v2z:function(Value){gx.O.Z5LocalidadId=gx.num.intval(Value)},v2c:function(){gx.fn.setControlValue("LOCALIDADID",gx.O.A5LocalidadId,0);if (typeof(this.dom_hdl) == 'function') this.dom_hdl.call(gx.O);},c2v:function(){gx.O.A5LocalidadId=gx.num.intval(this.val())},val:function(){return gx.fn.getIntegerValue("LOCALIDADID",'.')},nac:gx.falseFn};
   this.declareDomainHdlr( 33 , function() {
   });
   GXValidFnc[34]={fld:"",grid:0};
   GXValidFnc[35]={fld:"",grid:0};
   GXValidFnc[36]={fld:"",grid:0};
   GXValidFnc[37]={lvl:0,type:"svchar",len:250,dec:0,sign:false,ro:0,multiline:true,grid:0,gxgrid:null,fnc:null,isvalid:null,rgrid:[],fld:"LOCALIDADNOMBRE",gxz:"Z6LocalidadNombre",gxold:"O6LocalidadNombre",gxvar:"A6LocalidadNombre",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",v2v:function(Value){gx.O.A6LocalidadNombre=Value},v2z:function(Value){gx.O.Z6LocalidadNombre=Value},v2c:function(){gx.fn.setControlValue("LOCALIDADNOMBRE",gx.O.A6LocalidadNombre,0);if (typeof(this.dom_hdl) == 'function') this.dom_hdl.call(gx.O);},c2v:function(){gx.O.A6LocalidadNombre=this.val()},val:function(){return gx.fn.getControlValue("LOCALIDADNOMBRE")},nac:gx.falseFn};
   ...
   this.A6LocalidadNombre = "" ;
   this.Z6LocalidadNombre = "" ;
   this.O6LocalidadNombre = "" ;
   this.A5LocalidadId = 0 ;
   this.A6LocalidadNombre = "" ;
